...
public String  _vvvvvvvvvvvvvvvvvvvvvv6(anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper _parent,int _left,int _top,int _width,int _height) throws Exception{
...
_vvvvvvvvvvvvvvvvvvvv2.Initialize(ba,"mBase");
 //BA.debugLineNum = 200;BA.debugLine="Parent.AddNode(mBase, Left, Top, Width, Height)";
_parent.AddNode((javafx.scene.Node)(_vvvvvvvvvvvvvvvvvvvv2.getObject()),_left,_top,_width,_height);
...
_vvvvvvvvvvvvvvvvvvvv2.LoadLayout(ba,"CFMaterialCheckboxUI");
...
_vvvvvvvvvvvvvvvvvvvvv1._vvvvvvvvvvvv5((anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper(), (javafx.scene.Node)(_checkedlabel.getObject())),_color);
...
public String  _setvvvvvvvvvvvvvvvvvv5(int _iconcode) throws Exception{
