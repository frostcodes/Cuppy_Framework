...
public String  _base_resize(double _width,double _height) throws Exception{
 ...
 //BA.debugLineNum = 36;BA.debugLine="InnerButton.PrefWidth = Width";
_innerbutton.setPrefWidth(_width);
 //BA.debugLineNum = 37;BA.debugLine="InnerButton.PrefHeight =  Height";
...
_mbase = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Public InnerButton As Button";
...
_mbase = _base;
 //BA.debugLineNum = 26;BA.debugLine="mBase.LoadLayout(\"CFMaterialButtonUI\")";
_mbase.LoadLayout(ba,"CFMaterialButtonUI");
 //BA.debugLineNum = 28;BA.debugLine="SetBg(CFStyleManager.DefaultTheme.Get(\"accent\"))";
_setbg(BA.ObjectToString(_cfstylemanager._defaulttheme.Get((Object)("accent"))));
 //BA.debugLineNum = 29;BA.debugLine="InnerButton.Font = CFStyleManager.DefaultFont";
_innerbutton.setFont(_cfstylemanager._defaultfont);
 //BA.debugLineNum = 30;BA.debugLine="InnerButton.MouseCursor = fx.Cursors.HAND";
...
_mcallback = _callback;
 //BA.debugLineNum = 20;BA.debugLine="CFStyleManager.ActiveControls.add(Me)";
...
public String  _innerbutton_mouseentered(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Sub InnerButton_MouseEntered (EventData As MouseEv";
 //BA.debugLineNum = 98;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MouseEn";
...
public String  _innerbutton_mouseexited(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Sub InnerButton_MouseExited (EventData As MouseEve";
 //BA.debugLineNum = 104;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MouseEx";
...
public String  _innerbutton_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 90;BA.debugLine="Public Sub InnerButton_MousePressed (EventData As";
 //BA.debugLineNum = 92;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MousePr";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 83;BA.debugLine="CFControlsUtils.removeEffect(InnerButton)";
...
public String  _setbg(String _color) throws Exception{
 ...
 //BA.debugLineNum = 51;BA.debugLine="CSSUtils.SetStyleProperty( InnerButton, \"-fx-back";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 63;BA.debugLine="CFControlsUtils.setBorder(InnerButton, color, wid";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 70;BA.debugLine="CFControlsUtils.setBorderRadius(InnerButton, radi";
...
public String  _seteffect(String _effect) throws Exception{
 //BA.debugLineNum = 75;BA.debugLine="Public Sub setEffect(effect As String)";
 //BA.debugLineNum = 77;BA.debugLine="CFControlsUtils.setEffect(InnerButton, effect)";
...
public String  _setrotationx(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 57;BA.debugLine="CFControlsUtils.setRotationX(InnerButton, angle)";
