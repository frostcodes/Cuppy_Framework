...
public double  _getalpha() throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Public Sub getAlpha As Double";
 //BA.debugLineNum = 154;BA.debugLine="Return mBase.Alpha";
...
public String  _geteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 99;BA.debugLine="Return CFControlsUtils.GetEffect(InnerButton)";
...
public boolean  _getenabled() throws Exception{
 //BA.debugLineNum = 126;BA.debugLine="Public Sub getEnabled As Boolean";
 //BA.debugLineNum = 128;BA.debugLine="Return mBase.Enabled";
if (true) return _mbase.getEnabled();
 //BA.debugLineNum = 130;BA.debugLine="End Sub";
return false;
}
public double  _getheight() throws Exception{
 //BA.debugLineNum = 165;BA.debugLine="Public Sub getHeight As Double";
 //BA.debugLineNum = 167;BA.debugLine="Return mBase.PrefHeight";
if (true) return _mbase.getPrefHeight();
 //BA.debugLineNum = 169;BA.debugLine="End Sub";
return 0;
}
public double  _getleft() throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Public Sub getLeft As Double";
 //BA.debugLineNum = 209;BA.debugLine="Return mBase.Left";
...
public anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper  _getparent() throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Public Sub getParent As Node";
 //BA.debugLineNum = 188;BA.debugLine="Return mBase.Parent";
if (true) return _mbase.getParent();
 //BA.debugLineNum = 190;BA.debugLine="End Sub";
return null;
}
public Object  _gettag() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Public Sub getTag As Object";
 //BA.debugLineNum = 196;BA.debugLine="Return mBase.Tag";
if (true) return _mbase.getTag();
 //BA.debugLineNum = 198;BA.debugLine="End Sub";
return null;
}
public String  _gettext() throws Exception{
 //BA.debugLineNum = 117;BA.debugLine="Public Sub getText() As String";
...
public anywheresoftware.b4j.objects.JFX.PaintWrapper  _gettextcolor() throws Exception{
 //BA.debugLineNum = 261;BA.debugLine="Public Sub getTextColor As Paint";
 //BA.debugLineNum = 263;BA.debugLine="Return InnerButton.TextColor";
...
public double  _gettextsize() throws Exception{
 //BA.debugLineNum = 249;BA.debugLine="Public Sub getTextSize() As Double";
 //BA.debugLineNum = 251;BA.debugLine="Return InnerButton.TextSize";
if (true) return _innerbutton.getTextSize();
 //BA.debugLineNum = 253;BA.debugLine="End Sub";
return 0;
}
public double  _gettop() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Public Sub getTop As Double";
 //BA.debugLineNum = 181;BA.debugLine="Return mBase.Top";
if (true) return _mbase.getTop();
 //BA.debugLineNum = 183;BA.debugLine="End Sub";
return 0;
}
public boolean  _getvisible() throws Exception{
 //BA.debugLineNum = 139;BA.debugLine="Public Sub getVisible As Boolean";
...
public double  _getwidth() throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Public Sub getWidth As Double";
 //BA.debugLineNum = 174;BA.debugLine="Return mBase.PrefWidth";
...
public String  _innerbutton_mouseentered(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 277;BA.debugLine="Private Sub InnerButton_MouseEntered (EventData As";
 //BA.debugLineNum = 279;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MouseEn";
...
public String  _innerbutton_mouseexited(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 283;BA.debugLine="Private Sub InnerButton_MouseExited (EventData As";
 //BA.debugLineNum = 285;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MouseEx";
...
public String  _innerbutton_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 270;BA.debugLine="Private Sub InnerButton_MousePressed (EventData As";
 //BA.debugLineNum = 272;BA.debugLine="InnerButton.RequestFocus 'set focus";
_innerbutton.RequestFocus();
 //BA.debugLineNum = 273;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MousePr";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 105;BA.debugLine="CFControlsUtils.removeEffect(InnerButton)";
...
public String  _removenodefromparent() throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Public Sub RemoveNodeFromParent";
 //BA.debugLineNum = 218;BA.debugLine="mBase.RemoveNodeFromParent";
_mbase.RemoveNodeFromParent();
 //BA.debugLineNum = 220;BA.debugLine="End Sub";
return "";
}
public String  _setalpha(double _alpha) throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Public Sub setAlpha(Alpha As Double)";
 //BA.debugLineNum = 160;BA.debugLine="mBase.Alpha = Alpha";
...
public String  _setbg(String _color) throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="CFControlsUtils.SetBG( InnerButton, color)";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 79;BA.debugLine="CFControlsUtils.setBorder(InnerButton, color, wid";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 86;BA.debugLine="CFControlsUtils.setBorderRadius(InnerButton, radi";
...
public String  _seteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 93;BA.debugLine="CFControlsUtils.setEffect(InnerButton, effect)";
...
public String  _setenabled(boolean _enabled) throws Exception{
 ...
 //BA.debugLineNum = 134;BA.debugLine="mBase.Enabled = Enabled";
...
public String  _setrotation(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 73;BA.debugLine="CFControlsUtils.setRotation(InnerButton, angle) '";
...
public String  _settag(Object _tag) throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Public Sub setTag(Tag As Object)";
 //BA.debugLineNum = 202;BA.debugLine="mBase.Tag = Tag";
_mbase.setTag(_tag);
...
public String  _settext(String _text) throws Exception{
 ...
 //BA.debugLineNum = 113;BA.debugLine="InnerButton.Text = text";
...
public String  _settextcolor(anywheresoftware.b4j.objects.JFX.PaintWrapper _textcolor) throws Exception{
 //BA.debugLineNum = 255;BA.debugLine="Public Sub setTextColor(TextColor As Paint)";
 //BA.debugLineNum = 257;BA.debugLine="InnerButton.TextColor = TextColor";
...
public String  _settextsize(double _textsize) throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Public Sub setTextSize(TextSize As Double)";
 //BA.debugLineNum = 245;BA.debugLine="InnerButton.TextSize = TextSize";
_innerbutton.setTextSize(_textsize);
 //BA.debugLineNum = 247;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(boolean _visible) throws Exception{
 //BA.debugLineNum = 145;BA.debugLine="Public Sub setVisible(Visible As Boolean)";
 //BA.debugLineNum = 147;BA.debugLine="mBase.Visible = Visible";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Public Sub Snapshot As Image";
 //BA.debugLineNum = 225;BA.debugLine="Return mBase.Snapshot";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot2(anywheresoftware.b4j.objects.JFX.PaintWrapper _backgroundcolor) throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Public Sub Snapshot2(BackgroundColor As Paint) As";
 //BA.debugLineNum = 232;BA.debugLine="Return mBase.Snapshot2(BackgroundColor)";
