...
public String  _base_resize(double _width,double _height) throws Exception{
 ...
 //BA.debugLineNum = 33;BA.debugLine="InnerButton.PrefWidth = Width";
_innerbutton.setPrefWidth(_width);
 //BA.debugLineNum = 34;BA.debugLine="InnerButton.PrefHeight =  Height";
...
_mbase = _base;
 //BA.debugLineNum = 25;BA.debugLine="mBase.LoadLayout(\"CFMaterialButtonUI\")";
_mbase.LoadLayout(ba,"CFMaterialButtonUI");
 //BA.debugLineNum = 27;BA.debugLine="SetBg(CFStyleManager.DefaultTheme.Get(\"accent\"))";
_setbg(BA.ObjectToString(_cfstylemanager._defaulttheme.Get((Object)("accent"))));
 //BA.debugLineNum = 28;BA.debugLine="InnerButton.Font = CFStyleManager.DefaultFont";
...
public String  _innerbutton_mouseentered(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Sub InnerButton_MouseEntered (EventData As MouseEv";
 //BA.debugLineNum = 95;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MouseEn";
...
public String  _innerbutton_mouseexited(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub InnerButton_MouseExited (EventData As MouseEve";
 //BA.debugLineNum = 101;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MouseEx";
...
public String  _innerbutton_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Public Sub InnerButton_MousePressed (EventData As";
 //BA.debugLineNum = 89;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MousePr";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 80;BA.debugLine="CFControlsUtils.removeEffect(InnerButton)";
...
public String  _setbg(String _color) throws Exception{
 ...
 //BA.debugLineNum = 48;BA.debugLine="CSSUtils.SetStyleProperty( InnerButton, \"-fx-back";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 60;BA.debugLine="CFControlsUtils.setBorder(InnerButton, color, wid";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="CFControlsUtils.setBorderRadius(InnerButton, radi";
...
public String  _seteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 74;BA.debugLine="CFControlsUtils.setEffect(InnerButton, effect)";
...
public String  _setrotationx(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 54;BA.debugLine="CFControlsUtils.setRotationX(InnerButton, angle)";
