...
public String  _base_resize(double _width,double _height) throws Exception{
 ...
 //BA.debugLineNum = 31;BA.debugLine="InnerButton.PrefWidth = Width";
_innerbutton.setPrefWidth(_width);
 //BA.debugLineNum = 32;BA.debugLine="InnerButton.PrefHeight =  Height";
...
_mbase = _base;
 //BA.debugLineNum = 23;BA.debugLine="mBase.LoadLayout(\"CFMaterialButtonUI\")";
...
_setbg(BA.ObjectToString(_cfstylemanager._defaulttheme.Get((Object)("accent"))));
 //BA.debugLineNum = 26;BA.debugLine="InnerButton.Font = CFStyleManager.DefaultFont";
...
_mcallback = _callback;
 //BA.debugLineNum = 18;BA.debugLine="CFStyleManager.ActiveControls.add(EventName)";
_cfstylemanager._activecontrols.Add((Object)(_eventname));
...
public String  _innerbutton_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 85;BA.debugLine="Public Sub InnerButton_MousePressed (EventData As";
 //BA.debugLineNum = 87;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MousePr";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 78;BA.debugLine="CFControlsUtils.removeEffect(InnerButton)";
...
public String  _setbg(String _color) throws Exception{
 ...
 //BA.debugLineNum = 46;BA.debugLine="CSSUtils.SetStyleProperty( InnerButton, \"-fx-back";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 58;BA.debugLine="CFControlsUtils.setBorder(InnerButton, color, wid";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 65;BA.debugLine="CFControlsUtils.setBorderRadius(InnerButton, radi";
...
public String  _seteffect(String _effect) throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Public Sub setEffect(effect As String)";
 //BA.debugLineNum = 72;BA.debugLine="CFControlsUtils.setEffect(InnerButton, effect)";
...
public String  _setrotationx(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 52;BA.debugLine="CFControlsUtils.setRotationX(InnerButton, angle)";
