...
public double  _getalpha() throws Exception{
 //BA.debugLineNum = 136;BA.debugLine="Public Sub getAlpha As Double";
 //BA.debugLineNum = 138;BA.debugLine="Return mBase.Alpha";
...
public String  _geteffect(String _effect) throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Public Sub getEffect(effect As String) As String";
 //BA.debugLineNum = 95;BA.debugLine="Return CFControlsUtils.GetEffect(InnerCard)";
...
public boolean  _getenabled() throws Exception{
 ...
 //BA.debugLineNum = 112;BA.debugLine="Return mBase.Enabled";
if (true) return _mbase.getEnabled();
 //BA.debugLineNum = 114;BA.debugLine="End Sub";
return false;
}
public double  _getheight() throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Public Sub getHeight As Double";
 //BA.debugLineNum = 151;BA.debugLine="Return mBase.PrefHeight";
if (true) return _mbase.getPrefHeight();
 //BA.debugLineNum = 153;BA.debugLine="End Sub";
return 0;
}
public double  _getleft() throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Public Sub getLeft As Double";
 //BA.debugLineNum = 193;BA.debugLine="Return mBase.Left";
...
public anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper  _getparent() throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Public Sub getParent As Node";
 //BA.debugLineNum = 172;BA.debugLine="Return mBase.Parent";
if (true) return _mbase.getParent();
 //BA.debugLineNum = 174;BA.debugLine="End Sub";
return null;
}
public Object  _gettag() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Public Sub getTag As Object";
 //BA.debugLineNum = 180;BA.debugLine="Return mBase.Tag";
if (true) return _mbase.getTag();
 //BA.debugLineNum = 182;BA.debugLine="End Sub";
return null;
}
public double  _gettop() throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Public Sub getTop As Double";
 //BA.debugLineNum = 165;BA.debugLine="Return mBase.Top";
if (true) return _mbase.getTop();
 //BA.debugLineNum = 167;BA.debugLine="End Sub";
return 0;
}
public boolean  _getvisible() throws Exception{
 //BA.debugLineNum = 123;BA.debugLine="Public Sub getVisible As Boolean";
 //BA.debugLineNum = 125;BA.debugLine="Return mBase.Visible";
if (true) return _mbase.getVisible();
 //BA.debugLineNum = 127;BA.debugLine="End Sub";
return false;
}
public double  _getwidth() throws Exception{
 //BA.debugLineNum = 156;BA.debugLine="Public Sub getWidth As Double";
 //BA.debugLineNum = 158;BA.debugLine="Return mBase.PrefWidth";
...
public String  _innercard_mouseclicked(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 246;BA.debugLine="Private Sub InnerCard_MouseClicked (EventData As M";
 //BA.debugLineNum = 248;BA.debugLine="InnerCard.RequestFocus 'set focus";
_innercard.RequestFocus();
 //BA.debugLineNum = 249;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MouseCl";
...
public String  _innercard_mouseentered(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Private Sub InnerCard_MouseEntered (EventData As M";
 //BA.debugLineNum = 236;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MouseEn";
...
public String  _innercard_mouseexited(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 240;BA.debugLine="Private Sub InnerCard_MouseExited (EventData As Mo";
 //BA.debugLineNum = 242;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MouseEx";
...
anywheresoftware.b4a.objects.collections.Map _points = null;
 //BA.debugLineNum = 223;BA.debugLine="Private Sub InnerCard_Touch (Action As Int, X As F";
 //BA.debugLineNum = 225;BA.debugLine="Dim Points As Map";
_points = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 226;BA.debugLine="Points.Initialize";
_points.Initialize();
 //BA.debugLineNum = 227;BA.debugLine="Points.Put(\"X\", X )";
_points.Put((Object)("X"),(Object)(_x));
 //BA.debugLineNum = 228;BA.debugLine="Points.Put(\"Y\", Y )";
_points.Put((Object)("Y"),(Object)(_y));
 //BA.debugLineNum = 230;BA.debugLine="CallSubDelayed3( mCallBack, mEventName & \"_Touch\"";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 101;BA.debugLine="CFControlsUtils.removeEffect(InnerCard)";
...
public String  _removenodefromparent() throws Exception{
 //BA.debugLineNum = 200;BA.debugLine="Public Sub RemoveNodeFromParent";
 //BA.debugLineNum = 202;BA.debugLine="mBase.RemoveNodeFromParent";
_mbase.RemoveNodeFromParent();
 //BA.debugLineNum = 204;BA.debugLine="End Sub";
return "";
}
public String  _setalpha(double _alpha) throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Public Sub setAlpha(Alpha As Double)";
 //BA.debugLineNum = 144;BA.debugLine="mBase.Alpha = Alpha";
...
public String  _seteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 89;BA.debugLine="CFControlsUtils.setEffect(InnerCard, effect)";
...
public String  _setenabled(boolean _enabled) throws Exception{
 //BA.debugLineNum = 116;BA.debugLine="Public Sub setEnabled(Enabled As Boolean)";
...
public String  _settag(Object _tag) throws Exception{
 //BA.debugLineNum = 184;BA.debugLine="Public Sub setTag(Tag As Object)";
 //BA.debugLineNum = 186;BA.debugLine="mBase.Tag = Tag";
_mbase.setTag(_tag);
 //BA.debugLineNum = 188;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(boolean _visible) throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Public Sub setVisible(Visible As Boolean)";
 //BA.debugLineNum = 131;BA.debugLine="mBase.Visible = Visible";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot() throws Exception{
 //BA.debugLineNum = 207;BA.debugLine="Public Sub Snapshot As Image";
 //BA.debugLineNum = 209;BA.debugLine="Return mBase.Snapshot";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot2(anywheresoftware.b4j.objects.JFX.PaintWrapper _backgroundcolor) throws Exception{
 //BA.debugLineNum = 214;BA.debugLine="Public Sub Snapshot2(BackgroundColor As Paint) As";
 //BA.debugLineNum = 216;BA.debugLine="Return mBase.Snapshot2(BackgroundColor)";
