...
public static boolean  _boolval(Object _mixedvar) throws Exception{
 //BA.debugLineNum = 10;BA.debugLine="Public Sub boolval(mixedVar As Object) As Boolean";
 //BA.debugLineNum = 12;BA.debugLine="If mixedVar = False Then";
if ((_mixedvar).equals((Object)(anywheresoftware.b4a.keywords.Common.False))) { 
 //BA.debugLineNum = 13;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 16;BA.debugLine="If mixedVar = 0  Or mixedVar = 0.0 Then";
if ((_mixedvar).equals((Object)(0)) || (_mixedvar).equals((Object)(0.0))) { 
 //BA.debugLineNum = 17;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 20;BA.debugLine="If mixedVar = \"\" Or mixedVar = \"0\" Then";
if ((_mixedvar).equals((Object)("")) || (_mixedvar).equals((Object)("0"))) { 
 //BA.debugLineNum = 21;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 28;BA.debugLine="If mixedVar = Null  Or mixedVar = \"undefined\" The";
...
public static boolean  _isarraylist(Object _obj) throws Exception{
 //BA.debugLineNum = 92;BA.debugLine="Public Sub isArrayList(obj As Object) As Boolean";
 //BA.debugLineNum = 94;BA.debugLine="Return isTypeOf(obj, \"arraylist\")";
if (true) return _istypeof(_obj,"arraylist");
 //BA.debugLineNum = 96;BA.debugLine="End Sub";
return false;
}
public static boolean  _isboolean(Object _obj) throws Exception{
 //BA.debugLineNum = 64;BA.debugLine="Public Sub isBoolean(obj As Object) As Boolean";
 //BA.debugLineNum = 66;BA.debugLine="Return isTypeOf(obj, \"boolean\")";
if (true) return _istypeof(_obj,"boolean");
 //BA.debugLineNum = 68;BA.debugLine="End Sub";
return false;
}
public static boolean  _isdouble(Object _obj) throws Exception{
 //BA.debugLineNum = 85;BA.debugLine="Public Sub isDouble(obj As Object) As Boolean";
 //BA.debugLineNum = 87;BA.debugLine="Return isTypeOf(obj, \"double\")";
if (true) return _istypeof(_obj,"double");
 //BA.debugLineNum = 89;BA.debugLine="End Sub";
return false;
}
public static boolean  _isinteger(Object _obj) throws Exception{
 //BA.debugLineNum = 78;BA.debugLine="Public Sub isInteger(obj As Object) As Boolean";
 //BA.debugLineNum = 80;BA.debugLine="Return isTypeOf(obj, \"integer\")";
if (true) return _istypeof(_obj,"integer");
 //BA.debugLineNum = 82;BA.debugLine="End Sub";
return false;
}
public static boolean  _islist(Object _obj) throws Exception{
 //BA.debugLineNum = 100;BA.debugLine="Public Sub isList(obj As Object) As Boolean";
 //BA.debugLineNum = 102;BA.debugLine="Return isArrayList(obj)";
if (true) return _isarraylist(_obj);
 //BA.debugLineNum = 104;BA.debugLine="End Sub";
return false;
}
public static boolean  _isnull(Object _obj) throws Exception{
 //BA.debugLineNum = 108;BA.debugLine="Public Sub isNull(obj As Object) As Boolean";
 //BA.debugLineNum = 110;BA.debugLine="Return StringUtility.isNull(obj)";
if (true) return _stringutility._isnull(_obj);
 //BA.debugLineNum = 112;BA.debugLine="End Sub";
return false;
}
public static boolean  _isstring(Object _obj) throws Exception{
 //BA.debugLineNum = 71;BA.debugLine="Public Sub isString(obj As Object) As Boolean";
 //BA.debugLineNum = 73;BA.debugLine="Return isTypeOf(obj, \"string\")";
if (true) return _istypeof(_obj,"string");
 //BA.debugLineNum = 75;BA.debugLine="End Sub";
return false;
}
public static boolean  _istypeof(Object _obj,String _typeof) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Public Sub isTypeOf(obj As Object , TypeOf As Stri";
 //BA.debugLineNum = 59;BA.debugLine="Return strip_java_type(GetType(obj)) = TypeOf.ToL";
...
public static String  _strip_java_type(String _str) throws Exception{
 ...
 //BA.debugLineNum = 39;BA.debugLine="str = str.Replace(\"java.lang.\",\"\")";
_str = _str.replace("java.lang.","");
 //BA.debugLineNum = 40;BA.debugLine="str = str.Replace(\"java.util.\",\"\")";
_str = _str.replace("java.util.","");
 //BA.debugLineNum = 43;BA.debugLine="If str.Contains(\"$\") Then";
if (_str.contains("$")) { 
 //BA.debugLineNum = 45;BA.debugLine="str = StringUtility.breakStrAt( str, \"$\")";
_str = BA.ObjectToString(_stringutility._breakstrat(_str,"$"));
 //BA.debugLineNum = 46;BA.debugLine="str = StringUtility.trim_left_once(str, \"$\")";
_str = _stringutility._trim_left_once(_str,"$");
 //BA.debugLineNum = 47;BA.debugLine="str = StringUtility.trim_left_once(str, \"_\")";
_str = _stringutility._trim_left_once(_str,"_");
 };
 //BA.debugLineNum = 52;BA.debugLine="Return str.ToLowerCase";
