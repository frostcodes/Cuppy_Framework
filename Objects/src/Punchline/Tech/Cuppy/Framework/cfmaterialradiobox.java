...
_mbase = _base;
 //BA.debugLineNum = 31;BA.debugLine="mBase.LoadLayout(\"CFMaterialRadioBoxUI\")";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 87;BA.debugLine="CFControlsUtils.removePaneEffect(CheckboxPane)";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 69;BA.debugLine="CFControlsUtils.setPaneBorder(CheckboxPane, color";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 75;BA.debugLine="CFControlsUtils.setPaneBorderRadius(CheckboxPane,";
...
public String  _setpaneeffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 81;BA.debugLine="CFControlsUtils.setPaneEffect(CheckboxPane, effec";
...
public String  _setrotationx(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 63;BA.debugLine="CFControlsUtils.setPaneRotationX(CheckboxPane, an";
