...
public String  _checkboxpane_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Private Sub CheckboxPane_MousePressed (EventData A";
 //BA.debugLineNum = 173;BA.debugLine="CheckboxPane.RequestFocus 'set focus";
_checkboxpane.RequestFocus();
 //BA.debugLineNum = 175;BA.debugLine="If Not(Checked) Or IsIndeterminate Then";
if (__c.Not(_checked()) || _isindeterminate()) { 
 //BA.debugLineNum = 177;BA.debugLine="SetCheckState(CHECKED_STATE)";
_setcheckstate(_checked_state);
 }else {
 //BA.debugLineNum = 181;BA.debugLine="SetCheckState(UNCHECKED_STATE)";
...
public boolean  _checked() throws Exception{
 //BA.debugLineNum = 159;BA.debugLine="Public Sub Checked As Boolean";
 //BA.debugLineNum = 161;BA.debugLine="Return CheckedPane.Visible";
...
_checkboxpane = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Public CheckedPane As Pane";
_checkedpane = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Public UNCHECKED_STATE As Int = 0";
_unchecked_state = (int) (0);
 //BA.debugLineNum = 26;BA.debugLine="Public CHECKED_STATE As Int = 1";
_checked_state = (int) (1);
 //BA.debugLineNum = 27;BA.debugLine="Public INDETERMINATE_STATE As Int = 2";
_indeterminate_state = (int) (2);
 //BA.debugLineNum = 30;BA.debugLine="Private FirstTime As Boolean = False";
...
_mbase = _base;
 //BA.debugLineNum = 40;BA.debugLine="mBase.LoadLayout(\"CFMaterialRadioBoxUI\")";
_mbase.LoadLayout(ba,"CFMaterialRadioBoxUI");
 //BA.debugLineNum = 43;BA.debugLine="SetBorder(CFStyleManager.DefaultTheme.Get(\"divide";
_setborder(BA.ObjectToString(_cfstylemanager._defaulttheme.Get((Object)("divider"))),(int) (2));
 //BA.debugLineNum = 45;BA.debugLine="SetCheckedColor(CFStyleManager.DefaultTheme.Get(\"";
_setcheckedcolor(BA.ObjectToString(_cfstylemanager._defaulttheme.Get((Object)("primary"))));
 //BA.debugLineNum = 49;BA.debugLine="Dim checkedState As String = Props.Get(\"CheckedSt";
_checkedstate = BA.ObjectToString(_props.Get((Object)("CheckedState")));
 //BA.debugLineNum = 53;BA.debugLine="If checkedState = \"UNCHECKED\" Then";
if ((_checkedstate).equals("UNCHECKED")) { 
 //BA.debugLineNum = 55;BA.debugLine="SetCheckState(UNCHECKED_STATE)";
_setcheckstate(_unchecked_state);
 }else if((_checkedstate).equals("CHECKED")) { 
 //BA.debugLineNum = 59;BA.debugLine="SetCheckState(CHECKED_STATE)";
_setcheckstate(_checked_state);
 }else if((_checkedstate).equals("INDETERMINATE")) { 
 //BA.debugLineNum = 63;BA.debugLine="SetCheckState(INDETERMINATE_STATE)";
...
public boolean  _isindeterminate() throws Exception{
 //BA.debugLineNum = 165;BA.debugLine="Public Sub IsIndeterminate As Boolean";
 //BA.debugLineNum = 167;BA.debugLine="Return CheckedPane.Alpha = \"0.6\"";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 115;BA.debugLine="CFControlsUtils.RemoveEffect(CheckboxPane)";
...
public String  _setbg(String _color) throws Exception{
 //BA.debugLineNum = 83;BA.debugLine="Public Sub SetBg(color As String)";
 //BA.debugLineNum = 85;BA.debugLine="CFControlsUtils.SetBG( CheckboxPane, color)";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 97;BA.debugLine="CFControlsUtils.SetBorder(CheckboxPane, color, wi";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 103;BA.debugLine="CFControlsUtils.SetBorderRadius(CheckboxPane, rad";
...
public String  _setcheckedcolor(String _color) throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Public Sub SetCheckedColor(color As String)";
 //BA.debugLineNum = 123;BA.debugLine="CFControlsUtils.SetBG( CheckedPane, color)";
...
public String  _setcheckstate(int _value) throws Exception{
 //BA.debugLineNum = 127;BA.debugLine="Public Sub SetCheckState(value As Int)";
 //BA.debugLineNum = 129;BA.debugLine="If value = UNCHECKED_STATE Then";
if (_value==_unchecked_state) { 
 //BA.debugLineNum = 131;BA.debugLine="CheckedPane.Visible = False";
_checkedpane.setVisible(__c.False);
 //BA.debugLineNum = 132;BA.debugLine="CheckedPane.SetAlphaAnimated(300, 0 )";
_checkedpane.SetAlphaAnimated((int) (300),0);
 }else if(_value==_checked_state) { 
 //BA.debugLineNum = 136;BA.debugLine="CheckedPane.Visible = True";
_checkedpane.setVisible(__c.True);
 //BA.debugLineNum = 137;BA.debugLine="CheckedPane.SetAlphaAnimated(300, 1 )";
_checkedpane.SetAlphaAnimated((int) (300),1);
 }else {
 //BA.debugLineNum = 141;BA.debugLine="CheckedPane.SetAlphaAnimated(300, 0.6 )";
_checkedpane.SetAlphaAnimated((int) (300),0.6);
 //BA.debugLineNum = 142;BA.debugLine="CheckedPane.Visible = True";
_checkedpane.setVisible(__c.True);
 };
 //BA.debugLineNum = 146;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 149;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Checke";
__c.CallSubDelayed2(ba,_mcallback,_meventname+"_CheckedChanged",(Object)(_value));
 }else {
 //BA.debugLineNum = 153;BA.debugLine="FirstTime = True";
_firsttime = __c.True;
 };
...
public String  _seteffect(String _effect) throws Exception{
 //BA.debugLineNum = 107;BA.debugLine="Public Sub SetEffect(effect As String)";
 //BA.debugLineNum = 109;BA.debugLine="CFControlsUtils.SetEffect(CheckboxPane, effect)";
...
public String  _setrotation(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 91;BA.debugLine="CFControlsUtils.SetRotation(CheckboxPane, angle)";
