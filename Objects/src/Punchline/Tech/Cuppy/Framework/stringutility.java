...
public static String  _prepend_zero(int _num) throws Exception{
 ...
 //BA.debugLineNum = 912;BA.debugLine="Log(\"Num:  \" & num)";
anywheresoftware.b4a.keywords.Common.Log("Num:  "+BA.NumberToString(_num));
 //BA.debugLineNum = 914;BA.debugLine="If num < 10 And num > 0 Then";
if (_num<10 && _num>0) { 
 //BA.debugLineNum = 916;BA.debugLine="Log(\"Return:  \" & \"0\" & num)";
anywheresoftware.b4a.keywords.Common.Log("Return:  "+"0"+BA.NumberToString(_num));
 //BA.debugLineNum = 918;BA.debugLine="Return \"0\" & num";
if (true) return "0"+BA.NumberToString(_num);
 }else {
 //BA.debugLineNum = 922;BA.debugLine="Return num";
