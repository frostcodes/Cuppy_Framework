...
int _i = 0;
int _nextval = 0;
 //BA.debugLineNum = 737;BA.debugLine="Public Sub str_split (str As String, splitLength A";
 //BA.debugLineNum = 739;BA.debugLine="Dim chunks As List";
_chunks = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 740;BA.debugLine="chunks.Initialize";
_chunks.Initialize();
 //BA.debugLineNum = 742;BA.debugLine="If (isEmpty(str) Or splitLength < 1)  Then";
if ((_isempty(_str) || _splitlength<1)) { 
 //BA.debugLineNum = 744;BA.debugLine="Return chunks 'empty list";
if (true) return _chunks;
 }else if(_splitlength==_str.length()) { 
 //BA.debugLineNum = 748;BA.debugLine="chunks.Add(str)";
_chunks.Add((Object)(_str));
 //BA.debugLineNum = 749;BA.debugLine="Return chunks";
if (true) return _chunks;
 };
 //BA.debugLineNum = 753;BA.debugLine="Dim DivVal As Int  =  str.Length / splitLength";
_divval = (int) (_str.length()/(double)_splitlength);
 //BA.debugLineNum = 755;BA.debugLine="For i = 0 To DivVal";
{
final int step10 = 1;
final int limit10 = _divval;
_i = (int) (0) ;
for (;_i <= limit10 ;_i = _i + step10 ) {
 //BA.debugLineNum = 757;BA.debugLine="Dim nextVal As Int = i * splitLength";
_nextval = (int) (_i*_splitlength);
 //BA.debugLineNum = 759;BA.debugLine="If i = DivVal Then";
if (_i==_divval) { 
 //BA.debugLineNum = 762;BA.debugLine="chunks.add( str.SubString( nextVal))";
_chunks.Add((Object)(_str.substring(_nextval)));
 }else {
 //BA.debugLineNum = 767;BA.debugLine="chunks.add( str.SubString2( nextVal , nextVal +";
_chunks.Add((Object)(_str.substring(_nextval,(int) (_nextval+_splitlength))));
 };
 }
};
 //BA.debugLineNum = 773;BA.debugLine="Return chunks";
if (true) return _chunks;
...
public static int  _stripos(String _haystack,String _find) throws Exception{
 //BA.debugLineNum = 812;BA.debugLine="Public Sub stripos(haystack As String , find As St";
 //BA.debugLineNum = 814;BA.debugLine="haystack = haystack.ToLowerCase";
_haystack = _haystack.toLowerCase();
 //BA.debugLineNum = 815;BA.debugLine="find = find.ToLowerCase";
_find = _find.toLowerCase();
 //BA.debugLineNum = 817;BA.debugLine="Return haystack.IndexOf(find)";
...
public static int  _stripos2(String _haystack,String _find,int _start) throws Exception{
 //BA.debugLineNum = 828;BA.debugLine="Public Sub stripos2(haystack As String , find As S";
 //BA.debugLineNum = 830;BA.debugLine="haystack = haystack.ToLowerCase";
_haystack = _haystack.toLowerCase();
 //BA.debugLineNum = 831;BA.debugLine="find = find.ToLowerCase";
_find = _find.toLowerCase();
 //BA.debugLineNum = 833;BA.debugLine="Return haystack.IndexOf2(find, start)";
...
public static int  _strpos(String _haystack,String _find) throws Exception{
 //BA.debugLineNum = 786;BA.debugLine="Public Sub strpos(haystack As String , find As Str";
 //BA.debugLineNum = 788;BA.debugLine="Return haystack.IndexOf(find)";
if (true) return _haystack.indexOf(_find);
...
public static int  _strpos2(String _haystack,String _find,int _start) throws Exception{
 //BA.debugLineNum = 799;BA.debugLine="Public Sub strpos2(haystack As String , find As St";
 //BA.debugLineNum = 801;BA.debugLine="Return haystack.IndexOf2(find, start)";
if (true) return _haystack.indexOf(_find,_start);
 //BA.debugLineNum = 803;BA.debugLine="End Sub";
return 0;
}
public static int  _strripos(String _haystack,String _find) throws Exception{
 //BA.debugLineNum = 874;BA.debugLine="Public Sub strripos(haystack As String , find As S";
 //BA.debugLineNum = 876;BA.debugLine="haystack = haystack.ToLowerCase";
_haystack = _haystack.toLowerCase();
 //BA.debugLineNum = 877;BA.debugLine="find = find.ToLowerCase";
_find = _find.toLowerCase();
 //BA.debugLineNum = 879;BA.debugLine="Return haystack.LastIndexOf(find)";
...
public static int  _strripos2(String _haystack,String _find,int _start) throws Exception{
 //BA.debugLineNum = 890;BA.debugLine="Public Sub strripos2 (haystack As String , find As";
 //BA.debugLineNum = 892;BA.debugLine="haystack = haystack.ToLowerCase";
_haystack = _haystack.toLowerCase();
 //BA.debugLineNum = 893;BA.debugLine="find = find.ToLowerCase";
_find = _find.toLowerCase();
 //BA.debugLineNum = 895;BA.debugLine="Return haystack.LastIndexOf2(find, start)";
...
public static int  _strrpos(String _haystack,String _find) throws Exception{
 //BA.debugLineNum = 848;BA.debugLine="Public Sub strrpos(haystack As String , find As St";
 //BA.debugLineNum = 850;BA.debugLine="Return haystack.LastIndexOf(find)";
if (true) return _haystack.lastIndexOf(_find);
...
public static int  _strrpos2(String _haystack,String _find,int _start) throws Exception{
 //BA.debugLineNum = 861;BA.debugLine="Public Sub strrpos2(haystack As String , find As S";
 //BA.debugLineNum = 863;BA.debugLine="Return haystack.LastIndexOf2(find, start)";
if (true) return _haystack.lastIndexOf(_find,_start);
