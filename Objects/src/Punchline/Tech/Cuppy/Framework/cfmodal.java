...
public double  _getalpha() throws Exception{
 //BA.debugLineNum = 179;BA.debugLine="Public Sub getAlpha As Double";
 //BA.debugLineNum = 181;BA.debugLine="Return mBase.Alpha";
...
public String  _geteffect(String _effect) throws Exception{
 //BA.debugLineNum = 101;BA.debugLine="Public Sub getEffect(effect As String) As String";
 //BA.debugLineNum = 103;BA.debugLine="Return CFControlsUtils.GetEffect(ModalPane)";
...
public boolean  _getenabled() throws Exception{
 //BA.debugLineNum = 153;BA.debugLine="Public Sub getEnabled As Boolean";
 //BA.debugLineNum = 155;BA.debugLine="Return mBase.Enabled";
if (true) return _mbase.getEnabled();
 //BA.debugLineNum = 157;BA.debugLine="End Sub";
return false;
}
public double  _getheight() throws Exception{
 //BA.debugLineNum = 192;BA.debugLine="Public Sub getHeight As Double";
 //BA.debugLineNum = 194;BA.debugLine="Return mBase.PrefHeight";
if (true) return _mbase.getPrefHeight();
 //BA.debugLineNum = 196;BA.debugLine="End Sub";
return 0;
}
public double  _getleft() throws Exception{
 //BA.debugLineNum = 234;BA.debugLine="Public Sub getLeft As Double";
 //BA.debugLineNum = 236;BA.debugLine="Return mBase.Left";
...
public anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper  _getparent() throws Exception{
 //BA.debugLineNum = 213;BA.debugLine="Public Sub getParent As Node";
 //BA.debugLineNum = 215;BA.debugLine="Return mBase.Parent";
...
public Object  _gettag() throws Exception{
 ...
 //BA.debugLineNum = 223;BA.debugLine="Return mBase.Tag";
if (true) return _mbase.getTag();
 //BA.debugLineNum = 225;BA.debugLine="End Sub";
return null;
}
public double  _gettop() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Public Sub getTop As Double";
 //BA.debugLineNum = 208;BA.debugLine="Return mBase.Top";
if (true) return _mbase.getTop();
 //BA.debugLineNum = 210;BA.debugLine="End Sub";
return 0;
}
public boolean  _getvisible() throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Public Sub getVisible As Boolean";
...
public double  _getwidth() throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Public Sub getWidth As Double";
 //BA.debugLineNum = 201;BA.debugLine="Return mBase.PrefWidth";
...
//C
this.state = -1;
 //BA.debugLineNum = 133;BA.debugLine="mBase.SetAlphaAnimated(300, 0)";
parent._mbase.SetAlphaAnimated((int) (300),0);
 //BA.debugLineNum = 135;BA.debugLine="Wait For mBase_AnimationCompleted";
...
this.state = -1;
;
 //BA.debugLineNum = 137;BA.debugLine="ModalBgPane.Visible = False";
parent._modalbgpane.setVisible(parent.__c.False);
 //BA.debugLineNum = 138;BA.debugLine="ModalPane.Visible = False";
parent._modalpane.setVisible(parent.__c.False);
 //BA.debugLineNum = 140;BA.debugLine="mBase.SetSize(0, 0)";
parent._mbase.SetSize(0,0);
 //BA.debugLineNum = 141;BA.debugLine="mBase.Enabled = False";
...
public String  _modalbgpane_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 268;BA.debugLine="Private Sub ModalBgPane_MousePressed (EventData As";
 //BA.debugLineNum = 270;BA.debugLine="ModalPane.RequestFocus 'set focus";
_modalpane.RequestFocus();
 //BA.debugLineNum = 272;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_ModalBG";
...
public String  _modalbgpane_resize(double _width,double _height) throws Exception{
 //BA.debugLineNum = 290;BA.debugLine="Sub ModalBgPane_Resize (Width As Double, Height As";
 //BA.debugLineNum = 292;BA.debugLine="CallSubDelayed3(mCallBack, mEventName & \"_ModalBg";
...
public String  _modalpane_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 276;BA.debugLine="Private Sub ModalPane_MousePressed (EventData As M";
 //BA.debugLineNum = 278;BA.debugLine="ModalPane.RequestFocus 'set focus";
_modalpane.RequestFocus();
 //BA.debugLineNum = 280;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_ModalPr";
...
public String  _modalpane_resize(double _width,double _height) throws Exception{
 //BA.debugLineNum = 284;BA.debugLine="Sub ModalPane_Resize (Width As Double, Height As D";
 //BA.debugLineNum = 286;BA.debugLine="CallSubDelayed3(mCallBack, mEventName & \"_ModalPa";
__c.CallSubDelayed3(ba,_mcallback,_meventname+"_ModalPaneResize",(Object)(_width),(Object)(_height));
 //BA.debugLineNum = 288;BA.debugLine="End Sub";
return "";
}
public String  _removeeffects() throws Exception{
 //BA.debugLineNum = 107;BA.debugLine="Public Sub RemoveEffects()";
 //BA.debugLineNum = 109;BA.debugLine="CFControlsUtils.RemoveEffect(ModalPane)";
...
public String  _removenodefromparent() throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Public Sub RemoveNodeFromParent";
 //BA.debugLineNum = 245;BA.debugLine="mBase.RemoveNodeFromParent";
_mbase.RemoveNodeFromParent();
 //BA.debugLineNum = 247;BA.debugLine="End Sub";
return "";
}
public String  _setalpha(double _alpha) throws Exception{
 //BA.debugLineNum = 185;BA.debugLine="Public Sub setAlpha(Alpha As Double)";
 //BA.debugLineNum = 187;BA.debugLine="mBase.Alpha = Alpha";
...
public String  _setbg(String _color) throws Exception{
 ...
 //BA.debugLineNum = 71;BA.debugLine="CFControlsUtils.setBG( ModalPane, color)";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 83;BA.debugLine="CFControlsUtils.setBorder(ModalPane, color, width";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 90;BA.debugLine="CFControlsUtils.setBorderRadius(ModalPane, radius";
...
public String  _seteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 97;BA.debugLine="CFControlsUtils.setEffect(ModalPane, effect)";
...
public String  _setenabled(boolean _enabled) throws Exception{
 ...
 //BA.debugLineNum = 161;BA.debugLine="mBase.Enabled = Enabled";
...
public String  _setrotation(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 77;BA.debugLine="CFControlsUtils.setRotation(ModalPane, angle) 'ro";
...
public String  _settag(Object _tag) throws Exception{
 //BA.debugLineNum = 227;BA.debugLine="Public Sub setTag(Tag As Object)";
 //BA.debugLineNum = 229;BA.debugLine="mBase.Tag = Tag";
_mbase.setTag(_tag);
 //BA.debugLineNum = 231;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(boolean _visible) throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Public Sub setVisible(Visible As Boolean)";
 //BA.debugLineNum = 174;BA.debugLine="mBase.Visible = Visible";
...
anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper _parent = null;
 //BA.debugLineNum = 117;BA.debugLine="Public Sub Show";
 //BA.debugLineNum = 119;BA.debugLine="Dim Parent As Pane = GetBase.Parent";
...
_parent.setObject((javafx.scene.layout.Pane)(_getbase().getParent().getObject()));
 //BA.debugLineNum = 121;BA.debugLine="mBase.Enabled = True";
_mbase.setEnabled(__c.True);
 //BA.debugLineNum = 122;BA.debugLine="mBase.Alpha = 1";
_mbase.setAlpha(1);
 //BA.debugLineNum = 124;BA.debugLine="ModalBgPane.Visible = True";
_modalbgpane.setVisible(__c.True);
 //BA.debugLineNum = 125;BA.debugLine="ModalPane.Visible = True";
_modalpane.setVisible(__c.True);
 //BA.debugLineNum = 127;BA.debugLine="mBase.SetLayoutAnimated(300, 0 , 0,  Parent.Width";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot() throws Exception{
 //BA.debugLineNum = 250;BA.debugLine="Public Sub Snapshot As Image";
 //BA.debugLineNum = 252;BA.debugLine="Return mBase.Snapshot";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot2(anywheresoftware.b4j.objects.JFX.PaintWrapper _backgroundcolor) throws Exception{
 //BA.debugLineNum = 257;BA.debugLine="Public Sub Snapshot2(BackgroundColor As Paint) As";
 //BA.debugLineNum = 259;BA.debugLine="Return mBase.Snapshot2(BackgroundColor)";
