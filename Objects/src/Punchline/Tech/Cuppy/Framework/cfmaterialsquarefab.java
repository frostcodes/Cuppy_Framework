...
_mbase = _base;
 //BA.debugLineNum = 20;BA.debugLine="mBase.LoadLayout(\"CFMaterialSquareFABUI\")";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 76;BA.debugLine="CFControlsUtils.removeEffect(FAB_Btn)";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 56;BA.debugLine="CFControlsUtils.setBorder(FAB_Btn, color, width)";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 63;BA.debugLine="CFControlsUtils.setBorderRadius(FAB_Btn, radius)";
...
public String  _setpaneeffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 70;BA.debugLine="CFControlsUtils.setEffect(FAB_Btn, effect)";
...
public String  _setrotationx(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 50;BA.debugLine="CFControlsUtils.setRotationX(FAB_Btn, angle) 'rot";
