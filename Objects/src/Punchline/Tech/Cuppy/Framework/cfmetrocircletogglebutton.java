...
public boolean  _checked() throws Exception{
 ...
 //BA.debugLineNum = 161;BA.debugLine="Return CheckedStatus";
...
public String  _geteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 111;BA.debugLine="Return CFControlsUtils.GetEffect(ToggleButton)";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 117;BA.debugLine="CFControlsUtils.removeEffect(ToggleButton)";
...
public String  _setbg(String _color) throws Exception{
 //BA.debugLineNum = 79;BA.debugLine="Public Sub setBg(color As String)";
 //BA.debugLineNum = 81;BA.debugLine="CFControlsUtils.setBG(ToggleButton, color)";
...
public String  _setborder(String _color,int _width) throws Exception{
 //BA.debugLineNum = 91;BA.debugLine="Public Sub setBorder(color As String , width As In";
 //BA.debugLineNum = 93;BA.debugLine="CFControlsUtils.setBorder(ToggleButton, color, wi";
...
public String  _setborderradius(int _radius) throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Public Sub setBorderRadius(radius As Int)";
 //BA.debugLineNum = 99;BA.debugLine="CFControlsUtils.setBorderRadius(ToggleButton, rad";
...
public String  _setcheckstate(int _value) throws Exception{
 //BA.debugLineNum = 123;BA.debugLine="Public Sub setCheckState(value As Int)";
 //BA.debugLineNum = 125;BA.debugLine="If value = UNCHECKED_STATE Then";
if (_value==_unchecked_state) { 
 //BA.debugLineNum = 127;BA.debugLine="setBg(\"white\")";
_setbg("white");
 //BA.debugLineNum = 128;BA.debugLine="setBorder(\"#D6D6D6\", 2)";
_setborder("#D6D6D6",(int) (2));
 //BA.debugLineNum = 130;BA.debugLine="ToggleButton.TextColor = fx.Colors.RGB(91, 91, 9";
_togglebutton.setTextColor((javafx.scene.paint.Paint)(_fx.Colors.RGB((int) (91),(int) (91),(int) (91))));
 //BA.debugLineNum = 132;BA.debugLine="CheckedStatus = False";
_checkedstatus = __c.False;
 }else if(_value==_checked_state) { 
 //BA.debugLineNum = 137;BA.debugLine="setBorder(\"#2EA9DE\", 2)";
_setborder("#2EA9DE",(int) (2));
 //BA.debugLineNum = 138;BA.debugLine="setBg(\"rgb(65, 177, 225 )\")";
_setbg("rgb(65, 177, 225 )");
 //BA.debugLineNum = 140;BA.debugLine="ToggleButton.TextColor = fx.Colors.White";
_togglebutton.setTextColor(_fx.Colors.White);
 //BA.debugLineNum = 142;BA.debugLine="CheckedStatus = True";
...
public String  _seteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 105;BA.debugLine="CFControlsUtils.setEffect(ToggleButton, effect)";
...
public String  _setrotation(float _angle) throws Exception{
 //BA.debugLineNum = 85;BA.debugLine="Public Sub setRotation(angle As Float)";
 //BA.debugLineNum = 87;BA.debugLine="CFControlsUtils.setRotation(ToggleButton, angle)";
...
public String  _togglebutton_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 283;BA.debugLine="Private Sub ToggleButton_MousePressed (EventData A";
 //BA.debugLineNum = 285;BA.debugLine="ToggleButton.RequestFocus 'set focus";
_togglebutton.RequestFocus();
 //BA.debugLineNum = 287;BA.debugLine="If Not(Checked) Then";
if (__c.Not(_checked())) { 
 //BA.debugLineNum = 289;BA.debugLine="setCheckState(CHECKED_STATE)";
_setcheckstate(_checked_state);
 }else {
 //BA.debugLineNum = 293;BA.debugLine="setCheckState(UNCHECKED_STATE)";
_setcheckstate(_unchecked_state);
 };
