...
public String  _base_resize(double _width,double _height) throws Exception{
 ...
 //BA.debugLineNum = 42;BA.debugLine="ToggleButton.PrefHeight = Width";
...
public boolean  _checked() throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Public Sub checked As Boolean";
 //BA.debugLineNum = 123;BA.debugLine="Return CheckedStatus";
...
_mbase = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Public CHECKED_STATE As Int = 1";
_checked_state = (int) (1);
 //BA.debugLineNum = 18;BA.debugLine="Public UNCHECKED_STATE As Int = 0";
_unchecked_state = (int) (0);
 //BA.debugLineNum = 20;BA.debugLine="Private CheckedStatus As Boolean = False";
_checkedstatus = __c.False;
 //BA.debugLineNum = 21;BA.debugLine="Public ToggleButton As Label";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 87;BA.debugLine="CFControlsUtils.removeEffect(ToggleButton)";
...
public String  _setbg(String _color) throws Exception{
 ...
 //BA.debugLineNum = 57;BA.debugLine="CFControlsUtils.setBG(ToggleButton, color)";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 69;BA.debugLine="CFControlsUtils.setBorder(ToggleButton, color, wi";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 75;BA.debugLine="CFControlsUtils.setBorderRadius(ToggleButton, rad";
...
public String  _setcheckstate(int _value) throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Public Sub setCheckState(value As Int)";
 //BA.debugLineNum = 95;BA.debugLine="If value = UNCHECKED_STATE Then";
if (_value==_unchecked_state) { 
 //BA.debugLineNum = 97;BA.debugLine="SetBg(\"white\")";
_setbg("white");
 //BA.debugLineNum = 98;BA.debugLine="setBorder(\"#D6D6D6\", 2)";
_setborder("#D6D6D6",(int) (2));
 //BA.debugLineNum = 100;BA.debugLine="ToggleButton.TextColor = fx.Colors.RGB(91, 91, 9";
_togglebutton.setTextColor((javafx.scene.paint.Paint)(_fx.Colors.RGB((int) (91),(int) (91),(int) (91))));
 //BA.debugLineNum = 102;BA.debugLine="CheckedStatus = False";
_checkedstatus = __c.False;
 }else if(_value==_checked_state) { 
 //BA.debugLineNum = 107;BA.debugLine="setBorder(\"#2EA9DE\", 2)";
_setborder("#2EA9DE",(int) (2));
 //BA.debugLineNum = 108;BA.debugLine="SetBg(\"rgb(65, 177, 225 )\")";
_setbg("rgb(65, 177, 225 )");
 //BA.debugLineNum = 110;BA.debugLine="ToggleButton.TextColor = fx.Colors.White";
_togglebutton.setTextColor(_fx.Colors.White);
 //BA.debugLineNum = 112;BA.debugLine="CheckedStatus = True";
_checkedstatus = __c.True;
 };
 //BA.debugLineNum = 117;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Checked";
...
public String  _setpaneeffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 81;BA.debugLine="CFControlsUtils.setEffect(ToggleButton, effect)";
...
public String  _setrotationx(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 63;BA.debugLine="CFControlsUtils.setRotationX(ToggleButton, angle)";
