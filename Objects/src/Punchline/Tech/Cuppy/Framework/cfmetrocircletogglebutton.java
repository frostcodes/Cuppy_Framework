...
public String  _getbordercolor() throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Public Sub getBorderColor As String";
 //BA.debugLineNum = 112;BA.debugLine="Return CFControlsUtils.GetBorderColor(ToggleButto";
...
public int  _getborderradius() throws Exception{
 //BA.debugLineNum = 122;BA.debugLine="Public Sub getBorderRadius As Int";
 //BA.debugLineNum = 124;BA.debugLine="Return CFControlsUtils.GetBorderRadius(ToggleButt";
...
public int  _getborderwidth() throws Exception{
 //BA.debugLineNum = 116;BA.debugLine="Public Sub getBorderWidth As Int";
 //BA.debugLineNum = 118;BA.debugLine="Return CFControlsUtils.GetBorderWidth(ToggleButto";
...
public int  _getcheckstate() throws Exception{
 //BA.debugLineNum = 187;BA.debugLine="Public Sub getCheckState As Int";
 //BA.debugLineNum = 189;BA.debugLine="Return PrivateCheckState";
...
public String  _geteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 136;BA.debugLine="Return CFControlsUtils.GetEffect(ToggleButton)";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 142;BA.debugLine="CFControlsUtils.removeEffect(ToggleButton)";
...
public String  _setcheckstate(int _state) throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Public Sub setCheckState(state As Int)";
 //BA.debugLineNum = 151;BA.debugLine="If state = UNCHECKED_STATE Then";
if (_state==_unchecked_state) { 
 //BA.debugLineNum = 153;BA.debugLine="setBackgroundColor(\"white\")";
_setbackgroundcolor("white");
 //BA.debugLineNum = 154;BA.debugLine="setBorder(\"#D6D6D6\", 2)";
_setborder("#D6D6D6",(int) (2));
 //BA.debugLineNum = 156;BA.debugLine="ToggleButton.TextColor = fx.Colors.RGB(91, 91, 9";
_togglebutton.setTextColor((javafx.scene.paint.Paint)(_fx.Colors.RGB((int) (91),(int) (91),(int) (91))));
 //BA.debugLineNum = 158;BA.debugLine="CheckedStatus = False";
_checkedstatus = __c.False;
 }else if(_state==_checked_state) { 
 //BA.debugLineNum = 163;BA.debugLine="setBorder(\"#2EA9DE\", 2)";
_setborder("#2EA9DE",(int) (2));
 //BA.debugLineNum = 164;BA.debugLine="setBackgroundColor(\"rgb(65, 177, 225 )\")";
_setbackgroundcolor("rgb(65, 177, 225 )");
 //BA.debugLineNum = 166;BA.debugLine="ToggleButton.TextColor = fx.Colors.White";
_togglebutton.setTextColor(_fx.Colors.White);
 //BA.debugLineNum = 168;BA.debugLine="CheckedStatus = True";
_checkedstatus = __c.True;
 };
 //BA.debugLineNum = 172;BA.debugLine="If FirstTimeSetted Then";
if (_firsttimesetted) { 
 //BA.debugLineNum = 175;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Checke";
__c.CallSubDelayed2(ba,_mcallback,_meventname+"_CheckedChanged",(Object)(_state));
 }else {
 //BA.debugLineNum = 179;BA.debugLine="FirstTimeSetted = True";
_firsttimesetted = __c.True;
 };
 //BA.debugLineNum = 183;BA.debugLine="PrivateCheckState = state";
...
public String  _seteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 130;BA.debugLine="CFControlsUtils.setEffect(ToggleButton, effect)";
