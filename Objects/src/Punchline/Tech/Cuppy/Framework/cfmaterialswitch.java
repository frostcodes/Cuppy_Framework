...
public boolean  _checked() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Public Sub Checked As Boolean";
 //BA.debugLineNum = 184;BA.debugLine="Return SwitchBtn.Left = 23";
...
public double  _getalpha() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Public Sub getAlpha As Double";
 //BA.debugLineNum = 225;BA.debugLine="Return mBase.Alpha";
if (true) return _mbase.getAlpha();
 //BA.debugLineNum = 227;BA.debugLine="End Sub";
return 0;
}
public String  _getbackgroundcolor() throws Exception{
 //BA.debugLineNum = 93;BA.debugLine="Public Sub getBackgroundColor As String";
 //BA.debugLineNum = 95;BA.debugLine="Return CFControlsUtils.GetBackgroundColor(SwitchP";
...
public String  _geteffect(String _effect) throws Exception{
 //BA.debugLineNum = 123;BA.debugLine="Public Sub getEffect(effect As String) As String";
 //BA.debugLineNum = 125;BA.debugLine="Return CFControlsUtils.GetEffect(SwitchPane)";
...
public boolean  _getenabled() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Public Sub getEnabled As Boolean";
 //BA.debugLineNum = 199;BA.debugLine="Return mBase.Enabled";
if (true) return _mbase.getEnabled();
 //BA.debugLineNum = 201;BA.debugLine="End Sub";
return false;
}
public double  _getheight() throws Exception{
 //BA.debugLineNum = 236;BA.debugLine="Public Sub getHeight As Double";
 //BA.debugLineNum = 238;BA.debugLine="Return mBase.PrefHeight";
if (true) return _mbase.getPrefHeight();
 //BA.debugLineNum = 240;BA.debugLine="End Sub";
return 0;
}
public double  _getleft() throws Exception{
 //BA.debugLineNum = 278;BA.debugLine="Public Sub getLeft As Double";
 //BA.debugLineNum = 280;BA.debugLine="Return mBase.Left";
...
public anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper  _getparent() throws Exception{
 //BA.debugLineNum = 257;BA.debugLine="Public Sub getParent As Node";
 //BA.debugLineNum = 259;BA.debugLine="Return mBase.Parent";
if (true) return _mbase.getParent();
 //BA.debugLineNum = 261;BA.debugLine="End Sub";
return null;
}
public Object  _gettag() throws Exception{
 //BA.debugLineNum = 265;BA.debugLine="Public Sub getTag As Object";
 //BA.debugLineNum = 267;BA.debugLine="Return mBase.Tag";
if (true) return _mbase.getTag();
 //BA.debugLineNum = 269;BA.debugLine="End Sub";
return null;
}
public double  _gettop() throws Exception{
 //BA.debugLineNum = 250;BA.debugLine="Public Sub getTop As Double";
 //BA.debugLineNum = 252;BA.debugLine="Return mBase.Top";
...
public boolean  _getvisible() throws Exception{
 ...
 //BA.debugLineNum = 212;BA.debugLine="Return mBase.Visible";
if (true) return _mbase.getVisible();
 //BA.debugLineNum = 214;BA.debugLine="End Sub";
return false;
}
public double  _getwidth() throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Public Sub getWidth As Double";
 //BA.debugLineNum = 245;BA.debugLine="Return mBase.PrefWidth";
...
public boolean  _isindeterminate() throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Public Sub IsIndeterminate As Boolean";
 //BA.debugLineNum = 190;BA.debugLine="Return SwitchBtn.Alpha = \"0.6\"";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 132;BA.debugLine="CFControlsUtils.RemoveEffect(SwitchPane)";
...
public String  _removenodefromparent() throws Exception{
 //BA.debugLineNum = 287;BA.debugLine="Public Sub RemoveNodeFromParent";
 //BA.debugLineNum = 289;BA.debugLine="mBase.RemoveNodeFromParent";
_mbase.RemoveNodeFromParent();
 //BA.debugLineNum = 291;BA.debugLine="End Sub";
return "";
}
public String  _setalpha(double _alpha) throws Exception{
 //BA.debugLineNum = 229;BA.debugLine="Public Sub setAlpha(Alpha As Double)";
 //BA.debugLineNum = 231;BA.debugLine="mBase.Alpha = Alpha";
_mbase.setAlpha(_alpha);
 //BA.debugLineNum = 233;BA.debugLine="End Sub";
return "";
}
public String  _setbackgroundcolor(String _color) throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Public Sub setBackgroundColor(color As String)";
 //BA.debugLineNum = 89;BA.debugLine="CFControlsUtils.SetBackgroundColor( SwitchPane, c";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 107;BA.debugLine="CFControlsUtils.SetBorder(SwitchPane, color, widt";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 113;BA.debugLine="CFControlsUtils.SetBorderRadius(SwitchPane, radiu";
...
public String  _setcheckedcolor(String _color) throws Exception{
 //BA.debugLineNum = 138;BA.debugLine="Public Sub setCheckedColor(color As String)";
 //BA.debugLineNum = 140;BA.debugLine="CFControlsUtils.SetBackgroundColor( SwitchBtn, co";
...
public String  _setcheckstate(int _value) throws Exception{
 //BA.debugLineNum = 144;BA.debugLine="Public Sub setCheckState(value As Int)";
 //BA.debugLineNum = 146;BA.debugLine="If value = UNCHECKED_STATE Then";
if (_value==_unchecked_state) { 
 //BA.debugLineNum = 148;BA.debugLine="SwitchBtn.SetLayoutAnimated(200 , 10, SwitchBtn.";
_switchbtn.SetLayoutAnimated((int) (200),10,_switchbtn.getTop(),_switchbtn.getPrefWidth(),_switchbtn.getPrefHeight());
 //BA.debugLineNum = 149;BA.debugLine="SwitchPane.SetAlphaAnimated(200, 1 )";
_switchpane.SetAlphaAnimated((int) (200),1);
 //BA.debugLineNum = 150;BA.debugLine="setBackgroundColor(CFStyleManager.DefaultTheme.G";
_setbackgroundcolor(BA.ObjectToString(_cfstylemanager._defaulttheme.Get((Object)("divider"))));
 }else if(_value==_checked_state) { 
 //BA.debugLineNum = 155;BA.debugLine="SwitchPane.SetAlphaAnimated(200, 0.6 )";
_switchpane.SetAlphaAnimated((int) (200),0.6);
 //BA.debugLineNum = 156;BA.debugLine="setBackgroundColor(CFControlsUtils.getBackground";
_setbackgroundcolor(_cfcontrolsutils._getbackgroundcolor((anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper(), (javafx.scene.Node)(_switchbtn.getObject()))));
 //BA.debugLineNum = 158;BA.debugLine="SwitchBtn.SetLayoutAnimated(200 , 23 , SwitchBtn";
_switchbtn.SetLayoutAnimated((int) (200),23,_switchbtn.getTop(),_switchbtn.getPrefWidth(),_switchbtn.getPrefWidth());
 }else {
 //BA.debugLineNum = 162;BA.debugLine="SwitchBtn.SetLayoutAnimated(200 , 23 , SwitchBtn";
_switchbtn.SetLayoutAnimated((int) (200),23,_switchbtn.getTop(),_switchbtn.getPrefWidth(),_switchbtn.getPrefWidth());
 //BA.debugLineNum = 163;BA.debugLine="SwitchPane.SetAlphaAnimated(200, 1 )";
_switchpane.SetAlphaAnimated((int) (200),1);
 //BA.debugLineNum = 164;BA.debugLine="setBackgroundColor(CFStyleManager.DefaultTheme.G";
_setbackgroundcolor(BA.ObjectToString(_cfstylemanager._defaulttheme.Get((Object)("divider"))));
 };
 //BA.debugLineNum = 168;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 171;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Checke";
__c.CallSubDelayed2(ba,_mcallback,_meventname+"_CheckedChanged",(Object)(_value));
 }else {
 //BA.debugLineNum = 175;BA.debugLine="FirstTime = True";
_firsttime = __c.True;
 };
...
public String  _seteffect(String _effect) throws Exception{
 //BA.debugLineNum = 117;BA.debugLine="Public Sub setEffect(effect As String)";
 //BA.debugLineNum = 119;BA.debugLine="CFControlsUtils.SetEffect(SwitchPane, effect)";
...
public String  _setenabled(boolean _enabled) throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Public Sub setEnabled(Enabled As Boolean)";
 //BA.debugLineNum = 205;BA.debugLine="mBase.Enabled = Enabled";
_mbase.setEnabled(_enabled);
 //BA.debugLineNum = 207;BA.debugLine="End Sub";
return "";
}
public String  _setrotation(float _angle) throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Public Sub setRotation(angle As Float)";
 //BA.debugLineNum = 101;BA.debugLine="CFControlsUtils.SetRotation(SwitchPane, angle) 'r";
...
public String  _settag(Object _tag) throws Exception{
 //BA.debugLineNum = 271;BA.debugLine="Public Sub setTag(Tag As Object)";
 //BA.debugLineNum = 273;BA.debugLine="mBase.Tag = Tag";
_mbase.setTag(_tag);
 //BA.debugLineNum = 275;BA.debugLine="End Sub";
return "";
}
public String  _setvisible(boolean _visible) throws Exception{
 //BA.debugLineNum = 216;BA.debugLine="Public Sub setVisible(Visible As Boolean)";
 //BA.debugLineNum = 218;BA.debugLine="mBase.Visible = Visible";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot() throws Exception{
 //BA.debugLineNum = 294;BA.debugLine="Public Sub Snapshot As Image";
 //BA.debugLineNum = 296;BA.debugLine="Return mBase.Snapshot";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot2(anywheresoftware.b4j.objects.JFX.PaintWrapper _backgroundcolor) throws Exception{
 //BA.debugLineNum = 301;BA.debugLine="Public Sub Snapshot2(BackgroundColor As Paint) As";
 //BA.debugLineNum = 303;BA.debugLine="Return mBase.Snapshot2(BackgroundColor)";
...
public String  _switchbtn_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 328;BA.debugLine="Private Sub SwitchBtn_MousePressed (EventData As M";
 //BA.debugLineNum = 330;BA.debugLine="CallSub2(Me , \"SwitchPane_MousePressed\", EventDat";
...
public String  _switchpane_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 312;BA.debugLine="Private Sub SwitchPane_MousePressed (EventData As";
 //BA.debugLineNum = 314;BA.debugLine="SwitchBtn.RequestFocus 'set focus";
_switchbtn.RequestFocus();
 //BA.debugLineNum = 316;BA.debugLine="If Not(Checked) Or IsIndeterminate Then";
if (__c.Not(_checked()) || _isindeterminate()) { 
 //BA.debugLineNum = 318;BA.debugLine="setCheckState(CHECKED_STATE)";
_setcheckstate(_checked_state);
 }else {
 //BA.debugLineNum = 322;BA.debugLine="setCheckState(UNCHECKED_STATE)";
_setcheckstate(_unchecked_state);
 };
