...
public double  _getalpha() throws Exception{
 //BA.debugLineNum = 151;BA.debugLine="Public Sub getAlpha As Double";
 //BA.debugLineNum = 153;BA.debugLine="Return mBase.Alpha";
...
public String  _geteffect(String _effect) throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Public Sub getEffect(effect As String) As String";
 //BA.debugLineNum = 98;BA.debugLine="Return CFControlsUtils.GetEffect(InnerLabel)";
...
public boolean  _getenabled() throws Exception{
 //BA.debugLineNum = 125;BA.debugLine="Public Sub getEnabled As Boolean";
 //BA.debugLineNum = 127;BA.debugLine="Return mBase.Enabled";
if (true) return _mbase.getEnabled();
 //BA.debugLineNum = 129;BA.debugLine="End Sub";
return false;
}
public double  _getheight() throws Exception{
 //BA.debugLineNum = 164;BA.debugLine="Public Sub getHeight As Double";
 //BA.debugLineNum = 166;BA.debugLine="Return mBase.PrefHeight";
if (true) return _mbase.getPrefHeight();
 //BA.debugLineNum = 168;BA.debugLine="End Sub";
return 0;
}
public double  _getleft() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Public Sub getLeft As Double";
 //BA.debugLineNum = 208;BA.debugLine="Return mBase.Left";
if (true) return _mbase.getLeft();
 //BA.debugLineNum = 210;BA.debugLine="End Sub";
return 0;
}
public String  _getlink() throws Exception{
 //BA.debugLineNum = 116;BA.debugLine="Public Sub getLink() As String";
 //BA.debugLineNum = 118;BA.debugLine="Return InnerLabel.Text";
...
public anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper  _getparent() throws Exception{
 //BA.debugLineNum = 185;BA.debugLine="Public Sub getParent As Node";
 //BA.debugLineNum = 187;BA.debugLine="Return mBase.Parent";
if (true) return _mbase.getParent();
 //BA.debugLineNum = 189;BA.debugLine="End Sub";
return null;
}
public Object  _gettag() throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Public Sub getTag As Object";
 //BA.debugLineNum = 195;BA.debugLine="Return mBase.Tag";
if (true) return _mbase.getTag();
 //BA.debugLineNum = 197;BA.debugLine="End Sub";
return null;
}
public double  _gettop() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Public Sub getTop As Double";
 //BA.debugLineNum = 180;BA.debugLine="Return mBase.Top";
if (true) return _mbase.getTop();
 //BA.debugLineNum = 182;BA.debugLine="End Sub";
return 0;
}
public boolean  _getvisible() throws Exception{
 //BA.debugLineNum = 138;BA.debugLine="Public Sub getVisible As Boolean";
 //BA.debugLineNum = 140;BA.debugLine="Return mBase.Visible";
if (true) return _mbase.getVisible();
 //BA.debugLineNum = 142;BA.debugLine="End Sub";
return false;
}
public double  _getwidth() throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Public Sub getWidth As Double";
 //BA.debugLineNum = 173;BA.debugLine="Return mBase.PrefWidth";
...
public String  _innerlabel_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 240;BA.debugLine="Private Sub InnerLabel_MousePressed (EventData As";
 //BA.debugLineNum = 242;BA.debugLine="InnerLabel.RequestFocus 'set focus";
_innerlabel.RequestFocus();
 //BA.debugLineNum = 244;BA.debugLine="fx.ShowExternalDocument(InnerLabel.Text)";
...
public String  _removeeffects() throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Public Sub RemoveEffects()";
 //BA.debugLineNum = 104;BA.debugLine="CFControlsUtils.removeEffect(InnerLabel)";
...
public String  _removenodefromparent() throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="Public Sub RemoveNodeFromParent";
 //BA.debugLineNum = 217;BA.debugLine="mBase.RemoveNodeFromParent";
_mbase.RemoveNodeFromParent();
 //BA.debugLineNum = 219;BA.debugLine="End Sub";
return "";
}
public String  _setalpha(double _alpha) throws Exception{
 //BA.debugLineNum = 157;BA.debugLine="Public Sub setAlpha(Alpha As Double)";
 //BA.debugLineNum = 159;BA.debugLine="mBase.Alpha = Alpha";
...
public String  _setbg(String _color) throws Exception{
 ...
 //BA.debugLineNum = 62;BA.debugLine="CFControlsUtils.SetBg( InnerLabel, color)";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 80;BA.debugLine="CFControlsUtils.setBorder(InnerLabel, color, widt";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 86;BA.debugLine="CFControlsUtils.setBorderRadius(InnerLabel, radiu";
...
public String  _seteffect(String _effect) throws Exception{
 //BA.debugLineNum = 90;BA.debugLine="Public Sub setEffect(effect As String)";
 //BA.debugLineNum = 92;BA.debugLine="CFControlsUtils.setEffect(InnerLabel, effect)";
...
public String  _setlink(String _link) throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Public Sub setLink(link As String)";
 //BA.debugLineNum = 112;BA.debugLine="InnerLabel.Text = link";
_innerlabel.setText(_link);
 //BA.debugLineNum = 114;BA.debugLine="End Sub";
return "";
}
public String  _setrotation(float _angle) throws Exception{
 //BA.debugLineNum = 72;BA.debugLine="Public Sub setRotation(angle As Float)";
 //BA.debugLineNum = 74;BA.debugLine="CFControlsUtils.setRotation(InnerLabel, angle) 'r";
...
public String  _settag(Object _tag) throws Exception{
 //BA.debugLineNum = 199;BA.debugLine="Public Sub setTag(Tag As Object)";
 //BA.debugLineNum = 201;BA.debugLine="mBase.Tag = Tag";
_mbase.setTag(_tag);
 //BA.debugLineNum = 203;BA.debugLine="End Sub";
return "";
}
public String  _settextcolor(String _color) throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Public Sub setTextColor(color As String)";
 //BA.debugLineNum = 68;BA.debugLine="CFControlsUtils.setTextColor (InnerLabel, color)";
...
public String  _setvisible(boolean _visible) throws Exception{
 //BA.debugLineNum = 144;BA.debugLine="Public Sub setVisible(Visible As Boolean)";
 //BA.debugLineNum = 146;BA.debugLine="mBase.Visible = Visible";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot() throws Exception{
 //BA.debugLineNum = 222;BA.debugLine="Public Sub Snapshot As Image";
 //BA.debugLineNum = 224;BA.debugLine="Return mBase.Snapshot";
...
public anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper  _snapshot2(anywheresoftware.b4j.objects.JFX.PaintWrapper _backgroundcolor) throws Exception{
 //BA.debugLineNum = 229;BA.debugLine="Public Sub Snapshot2(BackgroundColor As Paint) As";
 //BA.debugLineNum = 231;BA.debugLine="Return mBase.Snapshot2(BackgroundColor)";
