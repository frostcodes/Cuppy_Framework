...
public String  _base_resize(double _width,double _height) throws Exception{
 ...
 //BA.debugLineNum = 35;BA.debugLine="InnerLabel.PrefWidth = Width";
_innerlabel.setPrefWidth(_width);
 //BA.debugLineNum = 36;BA.debugLine="InnerLabel.PrefHeight =  Height";
...
_vvvvvvvvvvvvvvvvvvv5 = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Public InnerLabel As Label";
...
_vvvvvvvvvvvvvvvvvvv5 = _base;
 //BA.debugLineNum = 24;BA.debugLine="mBase.LoadLayout(\"CFMetroLinkLabelUI\")";
_vvvvvvvvvvvvvvvvvvv5.LoadLayout(ba,"CFMetroLinkLabelUI");
 //BA.debugLineNum = 27;BA.debugLine="setTextColor(CFStyleManager.DefaultTheme.Get(\"pri";
_setvvvvvvvvvvvvvvvvvvv0(BA.ObjectToString(_vvvvvvvvvvvvvvvv5._vv5.Get((Object)("primary_text"))));
 //BA.debugLineNum = 28;BA.debugLine="InnerLabel.Font = CFStyleManager.SelectFont(\"Regu";
_innerlabel.setFont(_vvvvvvvvvvvvvvvv5._vvv3("Regular",12));
 //BA.debugLineNum = 29;BA.debugLine="InnerLabel.MouseCursor = fx.Cursors.HAND";
_innerlabel.setMouseCursor(_vvvvvvvvvvvvvvvv2.Cursors.HAND);
...
_vvvvvvvvvvvvvvvv2.ShowExternalDocument(_innerlabel.getText());
...
public String  _vvvvvvvvvvvvvvvvvv3() throws Exception{
 ...
 //BA.debugLineNum = 88;BA.debugLine="CFControlsUtils.removeEffect(InnerLabel)";
...
public String  _vvvvvvvvvvvvvv7(String _color) throws Exception{
 ...
 //BA.debugLineNum = 50;BA.debugLine="CFControlsUtils.SetBg( InnerLabel, color)";
...
public String  _vvvvvvvvvvvvvv0(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 68;BA.debugLine="CFControlsUtils.setBorder(InnerLabel, color, widt";
...
public String  _setvvvvvvvvvvvvvvvvvv6(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 75;BA.debugLine="CFControlsUtils.setBorderRadius(InnerLabel, radiu";
...
public String  _setvvvvvvvvvvvvvvvvvvv7(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 82;BA.debugLine="CFControlsUtils.setEffect(InnerLabel, effect)";
...
public String  _setvvvvvvvvvvvvvvvvvvv2(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 62;BA.debugLine="CFControlsUtils.setRotationX(InnerLabel, angle) '";
...
public String  _setvvvvvvvvvvvvvvvvvvv0(String _color) throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Public Sub setTextColor(color As String)";
 //BA.debugLineNum = 56;BA.debugLine="CFControlsUtils.setTextColor (InnerLabel, color)";
