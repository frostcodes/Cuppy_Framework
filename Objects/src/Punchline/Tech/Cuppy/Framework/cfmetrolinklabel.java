...
_vvvvvvvvvvvvvvvvvvv4.LoadLayout(ba,"CFMetroLinkLabelUI");
...
_innerlabel.setFont(_vvvvvvvvvvvvvvvvvvvv2._vvvvvvvvvv4("Regular",12));
 //BA.debugLineNum = 33;BA.debugLine="InnerLabel.MouseCursor = fx.Cursors.HAND";
_innerlabel.setMouseCursor(_vvvvvvvvvvvvvvvvvvv1.Cursors.HAND);
 //BA.debugLineNum = 36;BA.debugLine="setLink(Props.Get(\"Link\"))";
_setvvvvvvvvvvvvvvvvvvvvvvvv0(BA.ObjectToString(_props.Get((Object)("Link"))));
...
public String  _getvvvvvvvvvvvvvvvvvvvvvvvv0() throws Exception{
...
_vvvvvvvvvvvvvvvvvvv1.ShowExternalDocument(_innerlabel.getText());
...
public String  _setvvvvvvvvvvvvvvvvvvvvvvvv0(String _link) throws Exception{
