...
public static double  _vvvvvvvvvvvvv5(double _arg) throws Exception{
...
public static double  _vvvvvvvvvvvvv6(double _arg) throws Exception{
...
public static double  _vvvvvvvvvvvvv7(double _arg) throws Exception{
...
public static int  _vvvvvvvvvvvvv0(int _n,int _base) throws Exception{
int _result = 0;
int _multiplier = 0;
...
public static String  _vvvvvvvvvvvvvv1(int _n,int _base) throws Exception{
String _chars = "";
String _result = "";
...
public static int  _vvvvvvvvvvvvvv2(int _n,int _frombase,int _tobase) throws Exception{
int _t = 0;
...
_t = _vvvvvvvvvvvvvv3(_n,_frombase);
 //BA.debugLineNum = 140;BA.debugLine="Return ConvertFromDecimal(t,tobase)";
if (true) return _vvvvvvvvvvvvv0(_t,_tobase);
 //BA.debugLineNum = 142;BA.debugLine="End Sub";
return 0;
}
public static int  _vvvvvvvvvvvvvv3(int _n,int _base) throws Exception{
int _result = 0;
int _multiplier = 0;
...
public static int  _vvvvvvvvvvvvvv4(String _n,int _base) throws Exception{
int _result = 0;
String _st = "";
String _chars = "";
int _k = 0;
...
public static double  _vvvvvvvvvvvvvv5(double _arg) throws Exception{
...
if (true) return (_vvvvvvvvvvvvvv7(_arg)+_vvvvvvvvvvvvvv7(-_arg))/(double)2;
 //BA.debugLineNum = 52;BA.debugLine="End Sub";
return 0;
}
public static double  _vvvvvvvvvvvvvv6(double _angle) throws Exception{
...
public static double  _vvvvvvvvvvvvvv7(double _arg) throws Exception{
...
public static double  _vvvvvvvvvvvvvv0(double _x,double _y) throws Exception{
double _t = 0;
...
public static boolean  _vvvvvvvvvvvvvvv1(double _d) throws Exception{
...
public static double  _vvvvvvvvvvvvvvv2(anywheresoftware.b4a.objects.collections.List _data,boolean _roundup) throws Exception{
int _total = 0;
int _value = 0;
...
public static double  _vvvvvvvvvvvvvvv3(anywheresoftware.b4a.objects.collections.List _data) throws Exception{
...
if (true) return _vvvvvvvvvvvvvvv2(_data,anywheresoftware.b4a.keywords.Common.True);
...
public static double  _vvvvvvvvvvvvvvv4(double _number) throws Exception{
...
public static double  _vvvvvvvvvvvvvvv5(double _number) throws Exception{
...
if (true) return (_vvvvvvvvvvvvvv7(_number)-_vvvvvvvvvvvvvv7(-_number))/(double)2;
 //BA.debugLineNum = 166;BA.debugLine="End Sub";
return 0;
}
public static double  _vvvvvvvvvvvvvvv6(double _number) throws Exception{
...
if (true) return 1-2/(double)(_vvvvvvvvvvvvvv7(2*_number)+1);
