...
_innerpane = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private InnerButton As Button";
...
_mbase = _base;
 //BA.debugLineNum = 28;BA.debugLine="mBase.LoadLayout(\"CFMaterialAppBarUI\")";
_mbase.LoadLayout(ba,"CFMaterialAppBarUI");
 //BA.debugLineNum = 30;BA.debugLine="SetBg(CFStyleManager.DefaultTheme.Get(\"primary\"))";
...
public String  _icon(String _icontext) throws Exception{
 //BA.debugLineNum = 91;BA.debugLine="Public Sub Icon(IconText As String)";
 //BA.debugLineNum = 93;BA.debugLine="Label1.Text = IconText";
...
public String  _innerbutton_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Private Sub InnerButton_MousePressed (EventData As";
 //BA.debugLineNum = 99;BA.debugLine="InnerButton.RequestFocus 'set focus";
...
public String  _innerpane_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 105;BA.debugLine="Private Sub InnerPane_MousePressed (EventData As M";
 //BA.debugLineNum = 107;BA.debugLine="InnerPane.RequestFocus 'set focus";
_innerpane.RequestFocus();
 //BA.debugLineNum = 109;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_PaneMou";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 84;BA.debugLine="CFControlsUtils.removeEffect(Label1)";
...
public String  _setbg(String _color) throws Exception{
 ...
 //BA.debugLineNum = 50;BA.debugLine="CFControlsUtils.SetBG( Label1,  color)";
_cfcontrolsutils._setbg((anywheresoftware.b4j.objects.NodeWrapper.ControlWrapper.ConcreteControlWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.NodeWrapper.ControlWrapper.ConcreteControlWrapper(), (javafx.scene.control.Control)(_label1.getObject())),_color);
 //BA.debugLineNum = 51;BA.debugLine="CFControlsUtils.SetPaneBG( InnerPane, color)";
...
public String  _setborder(String _color,int _width) throws Exception{
 ...
 //BA.debugLineNum = 64;BA.debugLine="CFControlsUtils.setBorder(Label1, color, width)";
_cfcontrolsutils._setborder((anywheresoftware.b4j.objects.NodeWrapper.ControlWrapper.ConcreteControlWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.NodeWrapper.ControlWrapper.ConcreteControlWrapper(), (javafx.scene.control.Control)(_label1.getObject())),_color,_width);
 //BA.debugLineNum = 65;BA.debugLine="CFControlsUtils.setPaneBorder(InnerPane, color, w";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 71;BA.debugLine="CFControlsUtils.setBorderRadius(Label1, radius)";
_cfcontrolsutils._setborderradius((anywheresoftware.b4j.objects.NodeWrapper.ControlWrapper.ConcreteControlWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.NodeWrapper.ControlWrapper.ConcreteControlWrapper(), (javafx.scene.control.Control)(_label1.getObject())),_radius);
 //BA.debugLineNum = 72;BA.debugLine="CFControlsUtils.setPaneBorderRadius(InnerPane, ra";
...
public String  _setpaneeffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 78;BA.debugLine="CFControlsUtils.setEffect(Label1, effect)";
...
public String  _setrotationx(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 57;BA.debugLine="CFControlsUtils.setRotationX(Label1, angle) 'rota";
_cfcontrolsutils._setrotationx((anywheresoftware.b4j.objects.NodeWrapper.ControlWrapper.ConcreteControlWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.NodeWrapper.ControlWrapper.ConcreteControlWrapper(), (javafx.scene.control.Control)(_label1.getObject())),_angle);
 //BA.debugLineNum = 58;BA.debugLine="CFControlsUtils.setPaneRotationX(InnerPane , angl";
