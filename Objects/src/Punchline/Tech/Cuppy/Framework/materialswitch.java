...
if (_value==_unchecked_state) { 
 //BA.debugLineNum = 108;BA.debugLine="SwitchBtn.SetAlphaAnimated(300, 1 )";
_switchbtn.SetAlphaAnimated((int) (300),1);
 //BA.debugLineNum = 111;BA.debugLine="SwitchBtn.SetLayoutAnimated(300 , 10, SwitchBtn.";
_switchbtn.SetLayoutAnimated((int) (300),10,_switchbtn.getTop(),_switchbtn.getPrefWidth(),_switchbtn.getPrefHeight());
 }else if(_value==_checked_state) { 
 //BA.debugLineNum = 115;BA.debugLine="SwitchBtn.SetAlphaAnimated(300, 1 )";
_switchbtn.SetAlphaAnimated((int) (300),1);
 //BA.debugLineNum = 118;BA.debugLine="SwitchBtn.SetLayoutAnimated(300 , 23 , SwitchBtn";
_switchbtn.SetLayoutAnimated((int) (300),23,_switchbtn.getTop(),_switchbtn.getPrefWidth(),_switchbtn.getPrefWidth());
 }else {
 //BA.debugLineNum = 122;BA.debugLine="SwitchBtn.SetAlphaAnimated(300, 0.6 )";
_switchbtn.SetAlphaAnimated((int) (300),0.6);
 //BA.debugLineNum = 125;BA.debugLine="SwitchBtn.SetLayoutAnimated(300 , 23 , SwitchBtn";
_switchbtn.SetLayoutAnimated((int) (300),23,_switchbtn.getTop(),_switchbtn.getPrefWidth(),_switchbtn.getPrefWidth());
 };
