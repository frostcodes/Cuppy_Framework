...
public String  _base_resize(double _width,double _height) throws Exception{
 ...
 //BA.debugLineNum = 60;BA.debugLine="CallSubDelayed3(mCallBack, mEventName & \"_Resize\"";
...
_mcallback = new Object();
 //BA.debugLineNum = 24;BA.debugLine="Private mBase As Pane";
_mbase = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Private timer1 As Timer";
_timer1 = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 26;BA.debugLine="Private timer2 As Timer";
_timer2 = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 27;BA.debugLine="Private timer3 As Timer";
_timer3 = new anywheresoftware.b4a.objects.Timer();
 //BA.debugLineNum = 29;BA.debugLine="Private Pane1 As Pane";
_pane1 = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Private Pane2 As Pane";
_pane2 = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private Pane3 As Pane";
...
_mbase = _base;
 //BA.debugLineNum = 44;BA.debugLine="mBase.LoadLayout(\"CFBarPreLoaderUI\")";
_mbase.LoadLayout(ba,"CFBarPreLoaderUI");
 //BA.debugLineNum = 50;BA.debugLine="timer1.Initialize(\"Timer1\", 400)";
_timer1.Initialize(ba,"Timer1",(long) (400));
 //BA.debugLineNum = 51;BA.debugLine="timer2.Initialize(\"Timer2\", 400)";
_timer2.Initialize(ba,"Timer2",(long) (400));
 //BA.debugLineNum = 52;BA.debugLine="timer3.Initialize(\"Timer3\", 400)";
_timer3.Initialize(ba,"Timer3",(long) (400));
 //BA.debugLineNum = 54;BA.debugLine="Start";
_start();
 //BA.debugLineNum = 56;BA.debugLine="End Sub";
return "";
}
public String  _enabletimers(boolean _enabled) throws Exception{
 //BA.debugLineNum = 152;BA.debugLine="Private Sub EnableTimers(enabled As Boolean)";
 //BA.debugLineNum = 154;BA.debugLine="timer1.Enabled =  enabled";
_timer1.setEnabled(_enabled);
 //BA.debugLineNum = 155;BA.debugLine="timer2.Enabled =  enabled";
_timer2.setEnabled(_enabled);
 //BA.debugLineNum = 156;BA.debugLine="timer3.Enabled =  enabled";
_timer3.setEnabled(_enabled);
 //BA.debugLineNum = 158;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper  _getbase() throws Exception{
 //BA.debugLineNum = 64;BA.debugLine="Public Sub GetBase As Pane";
 //BA.debugLineNum = 65;BA.debugLine="Return mBase";
...
public String  _removeeffects() throws Exception{
 //BA.debugLineNum = 135;BA.debugLine="Public Sub RemoveEffects()";
 //BA.debugLineNum = 139;BA.debugLine="End Sub";
return "";
}
public String  _setbg(String _color) throws Exception{
 //BA.debugLineNum = 97;BA.debugLine="Public Sub SetBg(color As String)";
 //BA.debugLineNum = 101;BA.debugLine="End Sub";
return "";
}
public String  _setborder(String _color,int _width) throws Exception{
 //BA.debugLineNum = 115;BA.debugLine="Public Sub SetBorder(color As String , width As In";
...
public String  _seteffect(String _effect) throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Public Sub SetEffect(effect As String)";
 //BA.debugLineNum = 133;BA.debugLine="End Sub";
return "";
}
public String  _setrotationx(float _angle) throws Exception{
 //BA.debugLineNum = 109;BA.debugLine="Public Sub SetRotationX(angle As Float)";
 //BA.debugLineNum = 113;BA.debugLine="End Sub";
return "";
}
public String  _settextcolor(String _color) throws Exception{
 //BA.debugLineNum = 103;BA.debugLine="Public Sub SetTextColor(color As String)";
 //BA.debugLineNum = 107;BA.debugLine="End Sub";
return "";
}
public String  _start() throws Exception{
 //BA.debugLineNum = 161;BA.debugLine="Public Sub Start()";
 //BA.debugLineNum = 163;BA.debugLine="EnableTimers(True)";
_enabletimers(__c.True);
 //BA.debugLineNum = 164;BA.debugLine="CallSubDelayed(mCallBack, mEventName & \"_Animatio";
__c.CallSubDelayed(ba,_mcallback,_meventname+"_AnimationStarted");
 //BA.debugLineNum = 166;BA.debugLine="End Sub";
return "";
}
public String  _stop() throws Exception{
 //BA.debugLineNum = 169;BA.debugLine="Public Sub Stop()";
 //BA.debugLineNum = 171;BA.debugLine="EnableTimers(False)";
_enabletimers(__c.False);
 //BA.debugLineNum = 172;BA.debugLine="CallSubDelayed( mCallBack, mEventName & \"_Animati";
...
int _height = 0;
 //BA.debugLineNum = 70;BA.debugLine="Private Sub Timer1_Tick";
 //BA.debugLineNum = 73;BA.debugLine="Dim height As Int = (Rnd(30, 100) / 100 ) *  mBas";
_height = (int) ((__c.Rnd((int) (30),(int) (100))/(double)100)*_mbase.getPrefHeight());
 //BA.debugLineNum = 75;BA.debugLine="Pane1.SetLayoutAnimated( 300 , Pane1.Left, Pane1.";
...
int _height = 0;
 //BA.debugLineNum = 79;BA.debugLine="Private Sub Timer2_Tick";
 //BA.debugLineNum = 81;BA.debugLine="Dim height As Int = (Rnd(30, 100) / 100  ) *  mBa";
_height = (int) ((__c.Rnd((int) (30),(int) (100))/(double)100)*_mbase.getPrefHeight());
 //BA.debugLineNum = 83;BA.debugLine="Pane2.SetLayoutAnimated(300 , Pane2.Left, Pane2.T";
...
int _height = 0;
 //BA.debugLineNum = 87;BA.debugLine="Private Sub Timer3_Tick";
 //BA.debugLineNum = 89;BA.debugLine="Dim height As Int = (Rnd(30, 100) /100 ) *  mBase";
_height = (int) ((__c.Rnd((int) (30),(int) (100))/(double)100)*_mbase.getPrefHeight());
 //BA.debugLineNum = 91;BA.debugLine="Pane3.SetLayoutAnimated(300 , Pane3.Left, Pane3.T";
