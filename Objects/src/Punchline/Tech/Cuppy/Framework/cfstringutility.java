...
public static Object  _vv5(String _haystack,String _after) throws Exception{
String _found = "";
...
public static String  _vv6(String _str) throws Exception{
String _firstchar = "";
String _result = "";
String _txt = "";
...
{
final anywheresoftware.b4a.BA.IterableList group5 = _vvv2("_",_str);
...
_result = _result+_vvvvvvv0(_txt);
 }
};
...
public static boolean  _vv7(String _text) throws Exception{
...
public static String  _vv0(int _date) throws Exception{
...
public static String  _vvv1(String _value) throws Exception{
...
public static anywheresoftware.b4a.objects.collections.List  _vvv2(String _delimiter,String _str) throws Exception{
...
if (true) return _vvvvv0(_str,_delimiter);
 //BA.debugLineNum = 366;BA.debugLine="End Sub";
return null;
}
public static int  _vvv3(int _pinlength) throws Exception{
String _result = "";
...
public static String  _vvv4(int _strlength) throws Exception{
String _rndstring = "";
int _rndnumber = 0;
...
public static String  _vvv5(int _strlength) throws Exception{
String[] _randomarray = null;
String _result = "";
...
_result = _vvvvvv4(_vvvvv7(_randomarray));
 //BA.debugLineNum = 250;BA.debugLine="result = result  & GenerateRandomString( Floor( S";
_result = _result+_vvv4((int) (anywheresoftware.b4a.keywords.Common.Floor(_strlength/(double)2)));
 //BA.debugLineNum = 251;BA.debugLine="result = result  & StringArray2String(ShuffleArra";
_result = _result+_vvvvvv4(_vvvvv7(_randomarray));
...
public static String  _vvv6(String _str,String _separator) throws Exception{
...
if (true) return _vvvvvvvv1(_str.replace(_separator," "));
 //BA.debugLineNum = 466;BA.debugLine="End Sub";
return "";
}
public static String  _vvv7(String _separator,anywheresoftware.b4a.objects.collections.List _strlist) throws Exception{
String _result = "";
String _str = "";
...
public static boolean  _vvv0(String _emailaddress) throws Exception{
...
public static boolean  _vvvv1(String _str) throws Exception{
...
public static boolean  _vvvv2(String _c) throws Exception{
String _pattern = "";
...
public static boolean  _vvvv3(String _text) throws Exception{
String _pattern = "";
...
public static boolean  _vvvv5(String _text) throws Exception{
...
public static boolean  _vvvv6(String _ip) throws Exception{
...
public static String  _vvvv7(anywheresoftware.b4a.objects.collections.List _strlist,String _separator) throws Exception{
...
if (true) return _vvv7(_separator,_strlist);
 //BA.debugLineNum = 386;BA.debugLine="End Sub";
return "";
}
public static String  _vvvv0(String _str) throws Exception{
String _firstchar = "";
...
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("MMMM '"+_vv0(anywheresoftware.b4a.keywords.Common.DateTime.GetDayOfMonth(anywheresoftware.b4a.keywords.Common.DateTime.getNow()))+"', yyyy");
...
public static String  _vvvvv2(String _text) throws Exception{
...
public static anywheresoftware.b4a.objects.collections.Map  _vvvvv3(String _querystring) throws Exception{
...
_temp_list = _vvvvv0(_querystring,"&");
...
_querylist = _vvvvv0(BA.ObjectToString(_temp_list.Get(_i)),"=");
...
_data.Put(_querylist.Get((int) (0)),_querylist.Get((int) (1)));
			...
			ba.setLastException(e12); //BA.debugLineNum = 972;BA.debugLine="LogError(\"The parser for < parseQueryString() >";
...
public static anywheresoftware.b4a.objects.collections.Map  _vvvvv4(String _url) throws Exception{
...
_url = BA.ObjectToString(_vv5(_url,"?"));
...
if (true) return _vvvvv3(_url);
 //BA.debugLineNum = 995;BA.debugLine="End Sub";
return null;
}
public static String  _vvvvv5(String _text,int _count,String _suffix) throws Exception{
...
if (_vvvv1(_str) || _str.equalsIgnoreCase("http://")) { 
...
public static Object  _vvvvv6(anywheresoftware.b4a.objects.collections.List _listx) throws Exception{
...
public static String[]  _vvvvv7(String[] _stringarray) throws Exception{
String _arrayval = "";
int _random = 0;
int _i = 0;
...
public static anywheresoftware.b4a.objects.collections.List  _vvvvv0(String _str,String _delimiter) throws Exception{
...
_t = anywheresoftware.b4a.keywords.Common.ArrayToList(anywheresoftware.b4a.keywords.Common.Regex.Split(_vvv1(_delimiter),_str));
 //BA.debugLineNum = 357;BA.debugLine="Return t";
if (true) return _t;
 //BA.debugLineNum = 358;BA.debugLine="End Sub";
return null;
}
public static String  _vvvvvv1(String _fmt,Object[] _arg) throws Exception{
int _ai = 0;
int _fi = 0;
int _i = 0;
int _exp = 0;
...
public static String  _vvvvvv2(String _text) throws Exception{
...
if (true) return _vvvvvv3(_text,"");
 //BA.debugLineNum = 667;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvv3(String _text,String _seperator) throws Exception{
...
public static String  _vvvvvv4(String[] _strarray) throws Exception{
String _result = "";
String _str = "";
...
public static int  _vvvvvv5(String _haystack,String _find) throws Exception{
...
public static int  _vvvvvv6(String _haystack,String _find,int _start) throws Exception{
...
public static Object  _vvvvvv7(String _haystack,String _charlist) throws Exception{
int _i = 0;
...
public static int  _vvvvvv0(String _haystack,String _find) throws Exception{
...
public static int  _vvvvvvv1(String _haystack,String _find,int _start) throws Exception{
...
public static int  _vvvvvvv2(String _haystack,String _find) throws Exception{
...
public static int  _vvvvvvv3(String _haystack,String _find,int _start) throws Exception{
...
public static anywheresoftware.b4a.objects.collections.List  _vvvvvvv6(String _str) throws Exception{
...
public static String  _vvvvvvv7(String _txt,int _length) throws Exception{
...
public static String  _vvvvvvv0(String _str) throws Exception{
String _firstchar = "";
...
public static String  _vvvvvvvv1(String _str) throws Exception{
String _result = "";
String _txt = "";
String _firstchar = "";
...
{
final anywheresoftware.b4a.BA.IterableList group2 = _vvv2(" ",_str.toLowerCase());
final int groupLen2 = group2.getSize()
;int index2 = 0;
;
for (; index2 < groupLen2;index2++){
...
public static String  _vvvvvvvv2(String _str) throws Exception{
