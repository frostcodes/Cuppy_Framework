...
String _found = "";
 //BA.debugLineNum = 695;BA.debugLine="Public Sub BreakStrAt(haystack As String, after As";
 //BA.debugLineNum = 697;BA.debugLine="Dim found As String = \"\"";
_found = "";
 //BA.debugLineNum = 699;BA.debugLine="found= haystack.IndexOf(after)";
_found = BA.NumberToString(_haystack.indexOf(_after));
 //BA.debugLineNum = 701;BA.debugLine="If found = -1 Then";
...
if (true) return (Object)(anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 707;BA.debugLine="Return haystack.SubString(found)";
...
String _result = "";
String _txt = "";
 //BA.debugLineNum = 434;BA.debugLine="Public Sub Camelize(str As String)  As String";
 //BA.debugLineNum = 435;BA.debugLine="Dim firstChar, result As String =\"\"";
_firstchar = "";
_result = "";
 //BA.debugLineNum = 437;BA.debugLine="str= str.Replace(\" \", \"_\") 'make all spaces _";
_str = _str.replace(" ","_");
 //BA.debugLineNum = 439;BA.debugLine="firstChar = str.CharAt(0)";
_firstchar = BA.ObjectToString(_str.charAt((int) (0)));
 //BA.debugLineNum = 440;BA.debugLine="firstChar = firstChar.ToLowerCase";
_firstchar = _firstchar.toLowerCase();
 //BA.debugLineNum = 442;BA.debugLine="For Each txt As String In Explode(\"_\", str)";
{
...
_txt = BA.ObjectToString(group5.Get(index5));
 //BA.debugLineNum = 443;BA.debugLine="result = result & Ucfirst(txt)";
_result = _result+_ucfirst(_txt);
 }
};
 //BA.debugLineNum = 446;BA.debugLine="Return firstChar & result.SubString(1)";
...
public static String  _escapestring(String _value) throws Exception{
 //BA.debugLineNum = 348;BA.debugLine="Public Sub EscapeString(value As String) As String";
 //BA.debugLineNum = 350;BA.debugLine="Return \"\\\"& value";
...
public static anywheresoftware.b4a.objects.collections.List  _explode(String _delimiter,String _str) throws Exception{
 //BA.debugLineNum = 363;BA.debugLine="Public Sub Explode(delimiter As String ,  str As S";
 //BA.debugLineNum = 365;BA.debugLine="Return Split(str, delimiter)";
...
int _i = 0;
 //BA.debugLineNum = 265;BA.debugLine="Public Sub GeneratePinCode(PinLength As Int) As I";
 //BA.debugLineNum = 267;BA.debugLine="Dim result As String =\"\"";
_result = "";
 //BA.debugLineNum = 268;BA.debugLine="Dim RandomArray() As String = Array As String(1,2";
_randomarray = new String[]{BA.NumberToString(1),BA.NumberToString(2),BA.NumberToString(3),BA.NumberToString(4),BA.NumberToString(5),BA.NumberToString(6),BA.NumberToString(7),BA.NumberToString(8),BA.NumberToString(9),BA.NumberToString(0)};
 //BA.debugLineNum = 270;BA.debugLine="For i = 0 To PinLength - 1";
{
final int step3 = 1;
final int limit3 = (int) (_pinlength-1);
_i = (int) (0) ;
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 272;BA.debugLine="result = result &  RandomArray( Rnd( 0, Rnd(2, R";
_result = _result+_randomarray[anywheresoftware.b4a.keywords.Common.Rnd((int) (0),anywheresoftware.b4a.keywords.Common.Rnd((int) (2),(int) (_randomarray.length-1)))];
 ...
 //BA.debugLineNum = 276;BA.debugLine="Return  result";
...
String _rndstring = "";
int _rndnumber = 0;
 //BA.debugLineNum = 227;BA.debugLine="Public Sub GenerateRandomString(StrLength As Int)";
 //BA.debugLineNum = 228;BA.debugLine="Dim RndString As String";
_rndstring = "";
 //BA.debugLineNum = 229;BA.debugLine="Dim RndNumber As Int";
_rndnumber = 0;
 //BA.debugLineNum = 230;BA.debugLine="Do While RndString.Length < StrLength";
while (_rndstring.length()<_strlength) {
 //BA.debugLineNum = 231;BA.debugLine="RndNumber = Rnd(48,123) 'Yep, 123, because the l";
_rndnumber = anywheresoftware.b4a.keywords.Common.Rnd((int) (48),(int) (123));
 //BA.debugLineNum = 232;BA.debugLine="If (RndNumber >= 48 And RndNumber <= 57) Or (Rnd";
if ((_rndnumber>=48 && _rndnumber<=57) || (_rndnumber>=65 && _rndnumber<=90) || (_rndnumber>=97 && _rndnumber<=112)) { 
 //BA.debugLineNum = 233;BA.debugLine="RndString = RndString & Chr(RndNumber)";
_rndstring = _rndstring+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(_rndnumber));
 };
 }
;
 //BA.debugLineNum = 236;BA.debugLine="Return RndString";
...
String[] _randomarray = null;
String _result = "";
 //BA.debugLineNum = 244;BA.debugLine="Public Sub GenerateRandomString2(StrLength As Int)";
 //BA.debugLineNum = 246;BA.debugLine="Dim RandomArray() As String = Array As String(\"!\"";
_randomarray = new String[]{"!","@","#","$","%"};
 //BA.debugLineNum = 247;BA.debugLine="Dim result As String";
_result = "";
 //BA.debugLineNum = 250;BA.debugLine="result =  StringArray2String(ShuffleArray(RandomA";
...
_result = _result+_generaterandomstring((int) (anywheresoftware.b4a.keywords.Common.Floor(_strlength/(double)2)));
 //BA.debugLineNum = 252;BA.debugLine="result = result  & StringArray2String(ShuffleArra";
_result = _result+_stringarray2string(_shufflearray(_randomarray));
 //BA.debugLineNum = 253;BA.debugLine="result = result  & GenerateRandomString( Floor( S";
_result = _result+_generaterandomstring((int) (anywheresoftware.b4a.keywords.Common.Floor(_strlength/(double)2)));
 //BA.debugLineNum = 256;BA.debugLine="Return  result.SubString2( result.Length - StrLen";
...
public static String  _humanize(String _str,String _separator) throws Exception{
 //BA.debugLineNum = 460;BA.debugLine="Public Sub Humanize(str As String, separator As St";
 //BA.debugLineNum = 462;BA.debugLine="str= str.ToLowerCase";
_str = _str.toLowerCase();
 //BA.debugLineNum = 463;BA.debugLine="Return Ucwords(str.Replace(separator, \" \"))";
...
String _result = "";
String _str = "";
 //BA.debugLineNum = 370;BA.debugLine="Public Sub Implode(separator As String, StrList As";
 //BA.debugLineNum = 371;BA.debugLine="Dim result As String =\"\"";
_result = "";
 //BA.debugLineNum = 373;BA.debugLine="For Each str As String In StrList 'an array";
{
...
_str = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 374;BA.debugLine="result = result & str & separator";
_result = _result+_str+_separator;
 }
};
 //BA.debugLineNum = 377;BA.debugLine="Return Trim_Once(result, separator) ' trim separa";
...
long _foundlong = 0L;
 //BA.debugLineNum = 305;BA.debugLine="Public Sub Increment_String(str As String, separat";
 //BA.debugLineNum = 307;BA.debugLine="Dim parsed_str, foundInt As String =\"\"";
_parsed_str = "";
_foundint = "";
 //BA.debugLineNum = 308;BA.debugLine="Dim IndexOfSeperator  As Int = 0";
_indexofseperator = (int) (0);
 //BA.debugLineNum = 310;BA.debugLine="IndexOfSeperator = str.LastIndexOf(separator)  'f";
_indexofseperator = _str.lastIndexOf(_separator);
 //BA.debugLineNum = 312;BA.debugLine="If  IndexOfSeperator <> 0 Then";
if (_indexofseperator!=0) { 
 //BA.debugLineNum = 315;BA.debugLine="foundInt = str.SubString((IndexOfSeperator +1)";
_foundint = _str.substring((int) ((_indexofseperator+1)));
 //BA.debugLineNum = 319;BA.debugLine="If IsNumber(foundInt) Then";
if (anywheresoftware.b4a.keywords.Common.IsNumber(_foundint)) { 
 //BA.debugLineNum = 321;BA.debugLine="parsed_str = str.SubString2(0 , IndexOfSeperato";
_parsed_str = _str.substring((int) (0),_indexofseperator);
 //BA.debugLineNum = 326;BA.debugLine="Dim foundLong As Long = (foundInt + 1)";
_foundlong = (long) (((double)(Double.parseDouble(_foundint))+1));
 //BA.debugLineNum = 328;BA.debugLine="Return parsed_str & separator & foundLong";
if (true) return _parsed_str+_separator+BA.NumberToString(_foundlong);
 }else {
 //BA.debugLineNum = 333;BA.debugLine="Return str & separator & first";
if (true) return _str+_separator+BA.NumberToString(_first);
 };
 }else {
 //BA.debugLineNum = 340;BA.debugLine="Return str & separator & first";
if (true) return _str+_separator+BA.NumberToString(_first);
 };
...
public static String  _join(anywheresoftware.b4a.objects.collections.List _strlist,String _separator) throws Exception{
 //BA.debugLineNum = 383;BA.debugLine="Public Sub Join(StrList As List,separator As Strin";
 //BA.debugLineNum = 385;BA.debugLine="Return Implode(separator, StrList)";
...
String _firstchar = "";
 //BA.debugLineNum = 419;BA.debugLine="Public Sub Lcfirst(str As String) As String";
 //BA.debugLineNum = 421;BA.debugLine="Dim firstChar As String =\"\"";
_firstchar = "";
 //BA.debugLineNum = 422;BA.debugLine="firstChar= str.CharAt(0)";
_firstchar = BA.ObjectToString(_str.charAt((int) (0)));
 //BA.debugLineNum = 423;BA.debugLine="firstChar = firstChar.ToLowerCase";
_firstchar = _firstchar.toLowerCase();
 //BA.debugLineNum = 425;BA.debugLine="Return firstChar & str.SubString(1)";
...
anywheresoftware.b4a.objects.collections.List _querylist = null;
 //BA.debugLineNum = 938;BA.debugLine="Public Sub ParseQueryString(QueryString As String)";
 //BA.debugLineNum = 940;BA.debugLine="Dim Data As Map 'total data";
_data = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 941;BA.debugLine="Data.Initialize";
_data.Initialize();
 //BA.debugLineNum = 943;BA.debugLine="Try";
try { //BA.debugLineNum = 946;BA.debugLine="Dim temp_list As List = Split(QueryString, \"&\")";
_temp_list = new anywheresoftware.b4a.objects.collections.List();
_temp_list = _split(_querystring,"&");
 //BA.debugLineNum = 948;BA.debugLine="For i = 0 To temp_list.Size - 1";
{
final int step5 = 1;
final int limit5 = (int) (_temp_list.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit5 ;_i = _i + step5 ) {
 //BA.debugLineNum = 950;BA.debugLine="Dim QueryList As List = Split(temp_list.Get(i)";
_querylist = new anywheresoftware.b4a.objects.collections.List();
_querylist = _split(BA.ObjectToString(_temp_list.Get(_i)),"=");
 //BA.debugLineNum = 952;BA.debugLine="If Not(Data.ContainsKey(QueryList.Get(0))) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_data.ContainsKey(_querylist.Get((int) (0))))) { 
 //BA.debugLineNum = 954;BA.debugLine="Data.Put(QueryList.Get(0), QueryList.Get(1))";
_data.Put(_querylist.Get((int) (0)),_querylist.Get((int) (1)));
			...
			ba.setLastException(e12); //BA.debugLineNum = 962;BA.debugLine="LogError(\"The parser for < parseQueryString() >";
anywheresoftware.b4a.keywords.Common.LogError("The parser for < parseQueryString() > got broken. Please check input data");
 };
 //BA.debugLineNum = 966;BA.debugLine="Return Data";
...
public static anywheresoftware.b4a.objects.collections.Map  _parsequerystringurl(String _url) throws Exception{
 //BA.debugLineNum = 978;BA.debugLine="Public Sub ParseQueryStringUrl(url As String) As M";
 //BA.debugLineNum = 980;BA.debugLine="url= BreakStrAt(url, \"?\") ' Split URL from Query";
_url = BA.ObjectToString(_breakstrat(_url,"?"));
 //BA.debugLineNum = 981;BA.debugLine="url =  Trim_Left_Once(url, \"?\")";
_url = _trim_left_once(_url,"?");
 //BA.debugLineNum = 983;BA.debugLine="Return ParseQueryString(url)";
...
public static String  _prep_url(String _str) throws Exception{
 //BA.debugLineNum = 468;BA.debugLine="Public Sub Prep_url(str As String)  As String";
 //BA.debugLineNum = 470;BA.debugLine="str= str.Trim";
_str = _str.trim();
 //BA.debugLineNum = 472;BA.debugLine="If IsEmpty(str) Or str.EqualsIgnoreCase(\"http://\"";
if (_isempty(_str) || _str.equalsIgnoreCase("http://")) { 
 //BA.debugLineNum = 474;BA.debugLine="Return  \"\"";
if (true) return "";
 }else {
 //BA.debugLineNum = 478;BA.debugLine="If Not(str.StartsWith(\"http://\")) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_str.startsWith("http://"))) { 
 //BA.debugLineNum = 480;BA.debugLine="Return \"http://\" & str";
if (true) return "http://"+_str;
 }else {
 //BA.debugLineNum = 484;BA.debugLine="Return str";
if (true) return _str;
 };
 };
...
public static String  _prepend_zero(int _num) throws Exception{
 //BA.debugLineNum = 913;BA.debugLine="Public Sub Prepend_Zero(num As Int) As String";
 //BA.debugLineNum = 915;BA.debugLine="If num < 10 And num > 0 Then";
if (_num<10 && _num>0) { 
 //BA.debugLineNum = 917;BA.debugLine="Return \"0\" & num";
if (true) return "0"+BA.NumberToString(_num);
 }else {
 //BA.debugLineNum = 921;BA.debugLine="Return num";
...
_str = _str.replace("\"","&quot;");
 //BA.debugLineNum = 168;BA.debugLine="Return str";
if (true) return _str;
 //BA.debugLineNum = 170;BA.debugLine="End Sub";
return "";
}
public static Object  _randlistvalue(anywheresoftware.b4a.objects.collections.List _listx) throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="Public Sub RandListValue(ListX As List) As Object";
 //BA.debugLineNum = 217;BA.debugLine="Return ListX.Get(Rnd(0, ListX.Size -1))";
...
public static String  _reduce_double_slashes(String _str) throws Exception{
 //BA.debugLineNum = 176;BA.debugLine="Public Sub Reduce_Double_Slashes(str As String) As";
 //BA.debugLineNum = 178;BA.debugLine="If str.ToLowerCase.StartsWith(\"http://\") Then";
if (_str.toLowerCase().startsWith("http://")) { 
 //BA.debugLineNum = 180;BA.debugLine="str = str.Replace(\"//\" ,\"/\")";
_str = _str.replace("//","/");
 //BA.debugLineNum = 181;BA.debugLine="str =  str.Replace(\"http:/\" ,\"http://\")  'fix ba";
_str = _str.replace("http:/","http://");
 }else {
 //BA.debugLineNum = 185;BA.debugLine="str = str.Replace(\"//\" ,\"/\")";
_str = _str.replace("//","/");
 };
 //BA.debugLineNum = 189;BA.debugLine="Return str";
if (true) return _str;
...
int _random = 0;
int _i = 0;
 //BA.debugLineNum = 200;BA.debugLine="Public Sub ShuffleArray(StringArray() As String) A";
 //BA.debugLineNum = 202;BA.debugLine="Dim ArrayVal As String";
_arrayval = "";
 //BA.debugLineNum = 203;BA.debugLine="Dim Random As Int";
_random = 0;
 //BA.debugLineNum = 205;BA.debugLine="For i = 0 To StringArray.Length - 1";
{
final int step3 = 1;
final int limit3 = (int) (_stringarray.length-1);
_i = (int) (0) ;
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 206;BA.debugLine="Random = Rnd(i, StringArray.Length)";
_random = anywheresoftware.b4a.keywords.Common.Rnd(_i,_stringarray.length);
 //BA.debugLineNum = 207;BA.debugLine="ArrayVal = StringArray(i)";
_arrayval = _stringarray[_i];
 //BA.debugLineNum = 208;BA.debugLine="StringArray(i) = StringArray(Random)";
_stringarray[_i] = _stringarray[_random];
 //BA.debugLineNum = 209;BA.debugLine="StringArray(Random) = ArrayVal";
_stringarray[_random] = _arrayval;
 }
};
 //BA.debugLineNum = 211;BA.debugLine="Return StringArray";
...
anywheresoftware.b4a.objects.collections.List _t = null;
 //BA.debugLineNum = 355;BA.debugLine="Sub Split(str As String, delimiter As String) As L";
 //BA.debugLineNum = 356;BA.debugLine="Dim t As List";
_t = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 357;BA.debugLine="t = Regex.Split(EscapeString(delimiter), str)";
_t = anywheresoftware.b4a.keywords.Common.ArrayToList(anywheresoftware.b4a.keywords.Common.Regex.Split(_escapestring(_delimiter),_str));
 //BA.debugLineNum = 358;BA.debugLine="Return t";
if (true) return _t;
...
boolean _bdone = false;
 //BA.debugLineNum = 507;BA.debugLine="Public Sub Sprintf(fmt As String, arg() As Object)";
 //BA.debugLineNum = 508;BA.debugLine="Dim ai, fi, i As Int";
_ai = 0;
_fi = 0;
_i = 0;
 //BA.debugLineNum = 509;BA.debugLine="Dim exp, wid As Int";
_exp = 0;
_wid = 0;
 //BA.debugLineNum = 510;BA.debugLine="Dim stmp, ptmp, sres, c, t As String";
_stmp = "";
_ptmp = "";
_sres = "";
_c = "";
_t = "";
 //BA.debugLineNum = 511;BA.debugLine="Dim bdone As Boolean";
_bdone = false;
 //BA.debugLineNum = 513;BA.debugLine="ai = 0";
_ai = (int) (0);
 //BA.debugLineNum = 514;BA.debugLine="fi = 0";
_fi = (int) (0);
 //BA.debugLineNum = 515;BA.debugLine="stmp = \"\"";
_stmp = "";
 //BA.debugLineNum = 516;BA.debugLine="sres = \"\"";
_sres = "";
 //BA.debugLineNum = 518;BA.debugLine="Do While (fi < fmt.Length)";
while ((_fi<_fmt.length())) {
 //BA.debugLineNum = 519;BA.debugLine="c = fmt.CharAt(fi)";
_c = BA.ObjectToString(_fmt.charAt(_fi));
 //BA.debugLineNum = 520;BA.debugLine="fi = fi + 1";
_fi = (int) (_fi+1);
 //BA.debugLineNum = 522;BA.debugLine="If (c = \"%\") Then";
if (((_c).equals("%"))) { 
 //BA.debugLineNum = 523;BA.debugLine="stmp = \"\"";
_stmp = "";
 //BA.debugLineNum = 524;BA.debugLine="ptmp = \"\"";
_ptmp = "";
 //BA.debugLineNum = 525;BA.debugLine="bdone = False";
_bdone = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 527;BA.debugLine="Do While ((fi < fmt.Length) And (bdone = False)";
while (((_fi<_fmt.length()) && (_bdone==anywheresoftware.b4a.keywords.Common.False))) {
 //BA.debugLineNum = 528;BA.debugLine="c = fmt.CharAt(fi)";
_c = BA.ObjectToString(_fmt.charAt(_fi));
 //BA.debugLineNum = 529;BA.debugLine="fi = fi + 1";
_fi = (int) (_fi+1);
 //BA.debugLineNum = 531;BA.debugLine="If ((IsNumber(c) = True) Or (c = \".\")) Then";
if (((anywheresoftware.b4a.keywords.Common.IsNumber(_c)==anywheresoftware.b4a.keywords.Common.True) || ((_c).equals(".")))) { 
 //BA.debugLineNum = 532;BA.debugLine="ptmp = ptmp & c";
_ptmp = _ptmp+_c;
 //BA.debugLineNum = 533;BA.debugLine="bdone = False";
_bdone = anywheresoftware.b4a.keywords.Common.False;
 }else if(((_c).equals("s"))) { 
 //BA.debugLineNum = 535;BA.debugLine="stmp = arg(ai)";
_stmp = BA.ObjectToString(_arg[_ai]);
 //BA.debugLineNum = 536;BA.debugLine="ai = ai + 1";
_ai = (int) (_ai+1);
 //BA.debugLineNum = 537;BA.debugLine="sres = sres & stmp";
_sres = _sres+_stmp;
 //BA.debugLineNum = 538;BA.debugLine="bdone = True";
_bdone = anywheresoftware.b4a.keywords.Common.True;
 }else if(((_c).equals("d"))) { 
 //BA.debugLineNum = 540;BA.debugLine="If (ptmp.Length > 0) Then";
if ((_ptmp.length()>0)) { 
 //BA.debugLineNum = 541;BA.debugLine="t = \" \"";
_t = " ";
 //BA.debugLineNum = 542;BA.debugLine="If (ptmp.CharAt(0) = \"0\") Then";
if ((_ptmp.charAt((int) (0))==BA.ObjectToChar("0"))) { 
 //BA.debugLineNum = 543;BA.debugLine="t = \"0\"";
_t = "0";
 //BA.debugLineNum = 544;BA.debugLine="ptmp = ptmp.SubString(1)";
_ptmp = _ptmp.substring((int) (1));
 };
 };
 //BA.debugLineNum = 548;BA.debugLine="If (ptmp.Length > 0) Then wid = ptmp Else wid";
if ((_ptmp.length()>0)) { 
_wid = (int)(Double.parseDouble(_ptmp));}
else {
_wid = (int) (0);};
 //BA.debugLineNum = 550;BA.debugLine="stmp = arg(ai)";
_stmp = BA.ObjectToString(_arg[_ai]);
 //BA.debugLineNum = 552;BA.debugLine="Do While (stmp.Length < wid)";
while ((_stmp.length()<_wid)) {
 //BA.debugLineNum = 553;BA.debugLine="stmp = t & stmp";
_stmp = _t+_stmp;
 }
;
 //BA.debugLineNum = 556;BA.debugLine="ai = ai + 1";
_ai = (int) (_ai+1);
 //BA.debugLineNum = 557;BA.debugLine="sres = sres & stmp";
_sres = _sres+_stmp;
 //BA.debugLineNum = 558;BA.debugLine="bdone = True";
_bdone = anywheresoftware.b4a.keywords.Common.True;
 }else if(((_c).equals("f"))) { 
 //BA.debugLineNum = 560;BA.debugLine="If (ptmp.Length > 0) Then";
if ((_ptmp.length()>0)) { 
 //BA.debugLineNum = 561;BA.debugLine="i = ptmp.IndexOf(\".\")";
_i = _ptmp.indexOf(".");
 //BA.debugLineNum = 562;BA.debugLine="If (i >= 0) Then";
if ((_i>=0)) { 
 //BA.debugLineNum = 563;BA.debugLine="wid = ptmp.SubString2(0, i)";
_wid = (int)(Double.parseDouble(_ptmp.substring((int) (0),_i)));
 //BA.debugLineNum = 564;BA.debugLine="exp = ptmp.SubString(i+1)";
_exp = (int)(Double.parseDouble(_ptmp.substring((int) (_i+1))));
 }else {
 //BA.debugLineNum = 566;BA.debugLine="wid = ptmp";
_wid = (int)(Double.parseDouble(_ptmp));
 //BA.debugLineNum = 567;BA.debugLine="exp = 0";
_exp = (int) (0);
 };
 //BA.debugLineNum = 570;BA.debugLine="stmp = NumberFormat(arg(ai), wid, exp)";
_stmp = anywheresoftware.b4a.keywords.Common.NumberFormat((double)(BA.ObjectToNumber(_arg[_ai])),_wid,_exp);
 }else {
 //BA.debugLineNum = 572;BA.debugLine="stmp = arg(ai)";
_stmp = BA.ObjectToString(_arg[_ai]);
 };
 //BA.debugLineNum = 575;BA.debugLine="ai = ai + 1";
_ai = (int) (_ai+1);
 //BA.debugLineNum = 576;BA.debugLine="sres = sres & stmp";
_sres = _sres+_stmp;
 //BA.debugLineNum = 577;BA.debugLine="bdone = True";
_bdone = anywheresoftware.b4a.keywords.Common.True;
 }else {
 //BA.debugLineNum = 579;BA.debugLine="ai = ai + 1";
_ai = (int) (_ai+1);
 };
 }
;
 }else {
 //BA.debugLineNum = 584;BA.debugLine="sres = sres & c";
_sres = _sres+_c;
 };
 }
;
 //BA.debugLineNum = 588;BA.debugLine="Return(sres)";
...
String _result = "";
int _i = 0;
 //BA.debugLineNum = 670;BA.debugLine="Sub Str_Repeat(input As String, multiplier As Int)";
 //BA.debugLineNum = 672;BA.debugLine="If multiplier < 1 Then";
if (_multiplier<1) { 
 //BA.debugLineNum = 674;BA.debugLine="Return \"\"";
if (true) return "";
 }else {
 //BA.debugLineNum = 678;BA.debugLine="Dim result As String = \"\"";
_result = "";
 //BA.debugLineNum = 680;BA.debugLine="For i = 0 To multiplier - 1";
{
final int step5 = 1;
final int limit5 = (int) (_multiplier-1);
_i = (int) (0) ;
for (;_i <= limit5 ;_i = _i + step5 ) {
 //BA.debugLineNum = 682;BA.debugLine="result = result & input";
_result = _result+_input;
 }
};
 //BA.debugLineNum = 686;BA.debugLine="Return result";
...
int _i = 0;
int _nextval = 0;
 //BA.debugLineNum = 747;BA.debugLine="Public Sub Str_Split (str As String, splitLength A";
 //BA.debugLineNum = 749;BA.debugLine="Dim chunks As List";
_chunks = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 750;BA.debugLine="chunks.Initialize";
_chunks.Initialize();
 //BA.debugLineNum = 752;BA.debugLine="If (IsEmpty(str) Or splitLength < 1)  Then";
if ((_isempty(_str) || _splitlength<1)) { 
 //BA.debugLineNum = 754;BA.debugLine="Return chunks 'empty list";
if (true) return _chunks;
 }else if(_splitlength==_str.length()) { 
 //BA.debugLineNum = 758;BA.debugLine="chunks.Add(str)";
_chunks.Add((Object)(_str));
 //BA.debugLineNum = 759;BA.debugLine="Return chunks";
if (true) return _chunks;
 };
 //BA.debugLineNum = 763;BA.debugLine="Dim DivVal As Int  =  str.Length / splitLength";
_divval = (int) (_str.length()/(double)_splitlength);
 //BA.debugLineNum = 765;BA.debugLine="For i = 0 To DivVal";
{
final int step10 = 1;
final int limit10 = _divval;
_i = (int) (0) ;
for (;_i <= limit10 ;_i = _i + step10 ) {
 //BA.debugLineNum = 767;BA.debugLine="Dim nextVal As Int = i * splitLength";
_nextval = (int) (_i*_splitlength);
 //BA.debugLineNum = 769;BA.debugLine="If i = DivVal Then";
if (_i==_divval) { 
 //BA.debugLineNum = 772;BA.debugLine="chunks.add( str.SubString( nextVal))";
_chunks.Add((Object)(_str.substring(_nextval)));
 }else {
 //BA.debugLineNum = 777;BA.debugLine="chunks.add( str.SubString2( nextVal , nextVal +";
_chunks.Add((Object)(_str.substring(_nextval,(int) (_nextval+_splitlength))));
 };
 }
};
 //BA.debugLineNum = 783;BA.debugLine="Return chunks";
if (true) return _chunks;
 //BA.debugLineNum = 785;BA.debugLine="End Sub";
return null;
}
public static String  _string2ascii(String _text) throws Exception{
 //BA.debugLineNum = 657;BA.debugLine="Public Sub String2Ascii(text As String) As String";
 //BA.debugLineNum = 660;BA.debugLine="Return String2AsciiWithSeperator(text, \"\")";
...
int _i = 0;
 //BA.debugLineNum = 641;BA.debugLine="Public Sub String2AsciiWithSeperator(text As Strin";
 //BA.debugLineNum = 643;BA.debugLine="Dim result As StringBuilder";
_result = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 644;BA.debugLine="result.Initialize";
_result.Initialize();
 //BA.debugLineNum = 646;BA.debugLine="For i = 0 To text.Length - 1";
{
final int step3 = 1;
final int limit3 = (int) (_text.length()-1);
_i = (int) (0) ;
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 648;BA.debugLine="result.Append(Asc(text.CharAt(i)) & seperator)";
_result.Append(BA.NumberToString(anywheresoftware.b4a.keywords.Common.Asc(_text.charAt(_i)))+_seperator);
 }
};
 //BA.debugLineNum = 652;BA.debugLine="Return result.ToString.Trim";
...
String _result = "";
String _str = "";
 //BA.debugLineNum = 285;BA.debugLine="Public Sub StringArray2String(StrArray() As String";
 //BA.debugLineNum = 287;BA.debugLine="Dim result As String =\"\"";
_result = "";
 //BA.debugLineNum = 288;BA.debugLine="For Each str As String In StrArray 'an array";
{
...
for (; index2 < groupLen2;index2++){
_str = group2[index2];
 //BA.debugLineNum = 289;BA.debugLine="result = result & str";
_result = _result+_str;
 }
};
 //BA.debugLineNum = 292;BA.debugLine="Return result";
if (true) return _result;
...
public static int  _stripos(String _haystack,String _find) throws Exception{
 //BA.debugLineNum = 822;BA.debugLine="Public Sub Stripos(haystack As String , find As St";
 //BA.debugLineNum = 824;BA.debugLine="haystack = haystack.ToLowerCase";
_haystack = _haystack.toLowerCase();
 //BA.debugLineNum = 825;BA.debugLine="find = find.ToLowerCase";
...
public static int  _stripos2(String _haystack,String _find,int _start) throws Exception{
 //BA.debugLineNum = 838;BA.debugLine="Public Sub Stripos2(haystack As String , find As S";
 //BA.debugLineNum = 840;BA.debugLine="haystack = haystack.ToLowerCase";
_haystack = _haystack.toLowerCase();
 //BA.debugLineNum = 841;BA.debugLine="find = find.ToLowerCase";
_find = _find.toLowerCase();
 //BA.debugLineNum = 843;BA.debugLine="Return haystack.IndexOf2(find, start)";
...
int _i = 0;
 //BA.debugLineNum = 713;BA.debugLine="Public Sub Strpbrk(haystack As String, charList As";
 //BA.debugLineNum = 715;BA.debugLine="For i = 0 To haystack.Length - 1";
{
final int step1 = 1;
final int limit1 = (int) (_haystack.length()-1);
_i = (int) (0) ;
for (;_i <= limit1 ;_i = _i + step1 ) {
 //BA.debugLineNum = 717;BA.debugLine="If charList.IndexOf(haystack.CharAt(i)) >= 0 Th";
if (_charlist.indexOf(BA.ObjectToString(_haystack.charAt(_i)))>=0) { 
 //BA.debugLineNum = 719;BA.debugLine="Return haystack.SubString(i)";
if (true) return (Object)(_haystack.substring(_i));
 };
 }
};
 //BA.debugLineNum = 725;BA.debugLine="Return False";
if (true) return (Object)(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 727;BA.debugLine="End Sub";
return null;
}
public static int  _strpos(String _haystack,String _find) throws Exception{
 //BA.debugLineNum = 796;BA.debugLine="Public Sub Strpos(haystack As String , find As Str";
 //BA.debugLineNum = 798;BA.debugLine="Return haystack.IndexOf(find)";
if (true) return _haystack.indexOf(_find);
...
public static int  _strpos2(String _haystack,String _find,int _start) throws Exception{
 //BA.debugLineNum = 809;BA.debugLine="Public Sub Strpos2(haystack As String , find As St";
 //BA.debugLineNum = 811;BA.debugLine="Return haystack.IndexOf2(find, start)";
if (true) return _haystack.indexOf(_find,_start);
 //BA.debugLineNum = 813;BA.debugLine="End Sub";
return 0;
}
public static int  _strripos(String _haystack,String _find) throws Exception{
 //BA.debugLineNum = 884;BA.debugLine="Public Sub Strripos(haystack As String , find As S";
 //BA.debugLineNum = 886;BA.debugLine="haystack = haystack.ToLowerCase";
_haystack = _haystack.toLowerCase();
 //BA.debugLineNum = 887;BA.debugLine="find = find.ToLowerCase";
_find = _find.toLowerCase();
...
public static int  _strripos2(String _haystack,String _find,int _start) throws Exception{
 //BA.debugLineNum = 900;BA.debugLine="Public Sub Strripos2 (haystack As String , find As";
 //BA.debugLineNum = 902;BA.debugLine="haystack = haystack.ToLowerCase";
_haystack = _haystack.toLowerCase();
 //BA.debugLineNum = 903;BA.debugLine="find = find.ToLowerCase";
_find = _find.toLowerCase();
 //BA.debugLineNum = 905;BA.debugLine="Return haystack.LastIndexOf2(find, start)";
...
public static int  _strrpos(String _haystack,String _find) throws Exception{
 //BA.debugLineNum = 858;BA.debugLine="Public Sub Strrpos(haystack As String , find As St";
 //BA.debugLineNum = 860;BA.debugLine="Return haystack.LastIndexOf(find)";
if (true) return _haystack.lastIndexOf(_find);
...
public static int  _strrpos2(String _haystack,String _find,int _start) throws Exception{
 //BA.debugLineNum = 871;BA.debugLine="Public Sub Strrpos2(haystack As String , find As S";
 //BA.debugLineNum = 873;BA.debugLine="Return haystack.LastIndexOf2(find, start)";
if (true) return _haystack.lastIndexOf(_find,_start);
...
int _i = 0;
 //BA.debugLineNum = 731;BA.debugLine="Public Sub StrToStrList(str As String) As List";
 //BA.debugLineNum = 733;BA.debugLine="Dim result As List";
_result = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 734;BA.debugLine="result.Initialize";
_result.Initialize();
 //BA.debugLineNum = 736;BA.debugLine="For i = 0 To str.Length - 1";
{
final int step3 = 1;
final int limit3 = (int) (_str.length()-1);
_i = (int) (0) ;
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 738;BA.debugLine="result.Add(str.CharAt(i))";
_result.Add((Object)(_str.charAt(_i)));
 }
};
 //BA.debugLineNum = 742;BA.debugLine="Return result";
if (true) return _result;
...
public static String  _truncate(String _txt,int _length) throws Exception{
 //BA.debugLineNum = 991;BA.debugLine="Public Sub Truncate(txt As String, length As Int)";
 //BA.debugLineNum = 996;BA.debugLine="If length > txt.Length Then";
if (_length>_txt.length()) { 
 //BA.debugLineNum = 998;BA.debugLine="Return txt";
if (true) return _txt;
 }else {
 //BA.debugLineNum = 1002;BA.debugLine="Return txt.Substring2(0, length)";
...
String _firstchar = "";
 //BA.debugLineNum = 408;BA.debugLine="Public Sub Ucfirst(str As String) As String";
 //BA.debugLineNum = 410;BA.debugLine="Dim firstChar As String =\"\"";
_firstchar = "";
 //BA.debugLineNum = 411;BA.debugLine="firstChar= str.CharAt(0)";
_firstchar = BA.ObjectToString(_str.charAt((int) (0)));
 //BA.debugLineNum = 412;BA.debugLine="firstChar = firstChar.ToUpperCase";
_firstchar = _firstchar.toUpperCase();
 //BA.debugLineNum = 414;BA.debugLine="Return firstChar & str.SubString(1)";
if (true) return _firstchar+_str.substring((int) (1));
...
String _txt = "";
String _firstchar = "";
 //BA.debugLineNum = 391;BA.debugLine="Public Sub Ucwords(str As String) As String";
 //BA.debugLineNum = 393;BA.debugLine="Dim result As String =\"\"";
_result = "";
 //BA.debugLineNum = 395;BA.debugLine="For Each txt As String In Explode(\" \", str)";
{
...
_txt = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 396;BA.debugLine="Dim firstChar As String =\"\"";
_firstchar = "";
 //BA.debugLineNum = 397;BA.debugLine="firstChar= txt.CharAt(0)";
_firstchar = BA.ObjectToString(_txt.charAt((int) (0)));
 //BA.debugLineNum = 398;BA.debugLine="firstChar = firstChar.ToUpperCase";
_firstchar = _firstchar.toUpperCase();
 //BA.debugLineNum = 400;BA.debugLine="result = result & firstChar & txt.SubString(1) &";
_result = _result+_firstchar+_txt.substring((int) (1))+" ";
 }
};
 //BA.debugLineNum = 403;BA.debugLine="Return result";
if (true) return _result;
 //BA.debugLineNum = 405;BA.debugLine="End Sub";
return "";
}
public static String  _underscore(String _str) throws Exception{
 //BA.debugLineNum = 452;BA.debugLine="Public Sub Underscore(str As String)  As String";
 //BA.debugLineNum = 454;BA.debugLine="str= str.ToLowerCase";
_str = _str.toLowerCase();
 //BA.debugLineNum = 455;BA.debugLine="Return str.Replace(\" \",  \"_\")";
...
int _i = 0;
int _nextval = 0;
 //BA.debugLineNum = 597;BA.debugLine="Sub Word_Wrap(str As String, limit As Int) As Stri";
 //BA.debugLineNum = 599;BA.debugLine="str = str.Trim";
_str = _str.trim();
 //BA.debugLineNum = 601;BA.debugLine="If str.Length = limit Then";
if (_str.length()==_limit) { 
 //BA.debugLineNum = 603;BA.debugLine="Return str";
if (true) return _str;
 }else {
 //BA.debugLineNum = 607;BA.debugLine="Dim DivVal As Int";
_divval = 0;
 //BA.debugLineNum = 609;BA.debugLine="Dim stringBuild As StringBuilder";
_stringbuild = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 610;BA.debugLine="stringBuild.Initialize";
_stringbuild.Initialize();
 //BA.debugLineNum = 612;BA.debugLine="DivVal =  str.Length / limit";
_divval = (int) (_str.length()/(double)_limit);
 //BA.debugLineNum = 614;BA.debugLine="For i = 0 To DivVal";
{
final int step9 = 1;
final int limit9 = _divval;
_i = (int) (0) ;
for (;_i <= limit9 ;_i = _i + step9 ) {
 //BA.debugLineNum = 616;BA.debugLine="Dim nextVal As Int = i * limit";
_nextval = (int) (_i*_limit);
 //BA.debugLineNum = 618;BA.debugLine="If i = DivVal Then";
if (_i==_divval) { 
 //BA.debugLineNum = 621;BA.debugLine="stringBuild.Append( str.SubString( nextVal).Tr";
_stringbuild.Append(_str.substring(_nextval).trim());
 }else {
 //BA.debugLineNum = 626;BA.debugLine="stringBuild.Append( str.SubString2( nextVal ,";
_stringbuild.Append(_str.substring(_nextval,(int) (_nextval+_limit)).trim());
 //BA.debugLineNum = 627;BA.debugLine="stringBuild.Append( CRLF)";
_stringbuild.Append(anywheresoftware.b4a.keywords.Common.CRLF);
 };
 }
};
 //BA.debugLineNum = 633;BA.debugLine="Return stringBuild.ToString";
