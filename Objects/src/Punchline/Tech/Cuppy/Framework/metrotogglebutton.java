...
public class metrotogglebutton extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("Punchline.Tech.Cuppy.Framework", "Punchline.Tech.Cuppy.Framework.metrotogglebutton", this);
            if (htSubs == null) {
...
_mbase.LoadLayout(ba,"MetroToggleButton");
