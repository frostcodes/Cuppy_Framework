...
public class metrobutton extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    public static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("Punchline.Tech.Cuppy.Framework", "Punchline.Tech.Cuppy.Framework.metrobutton", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", Punchline.Tech.Cuppy.Framework.metrobutton.class).invoke(this, new Object[] {null});
        else
...
public String  _designercreateview(anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper _base,anywheresoftware.b4j.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Public Sub DesignerCreateView (Base As Pane, Lbl A";
 //BA.debugLineNum = 66;BA.debugLine="mBase = Base";
_mbase = _base;
 //BA.debugLineNum = 67;BA.debugLine="mBase.LoadLayout(\"MetroButton\")";
_mbase.LoadLayout(ba,"MetroButton");
 //BA.debugLineNum = 73;BA.debugLine="timer1.Initialize(\"Timer1\", 400)";
_timer1.Initialize(ba,"Timer1",(long) (400));
 //BA.debugLineNum = 74;BA.debugLine="timer1.Enabled = True";
_timer1.setEnabled(__c.True);
 //BA.debugLineNum = 76;BA.debugLine="timer2.Initialize(\"Timer2\", 400)";
_timer2.Initialize(ba,"Timer2",(long) (400));
 //BA.debugLineNum = 77;BA.debugLine="timer2.Enabled = True";
_timer2.setEnabled(__c.True);
 //BA.debugLineNum = 80;BA.debugLine="timer3.Initialize(\"Timer3\", 400)";
_timer3.Initialize(ba,"Timer3",(long) (400));
 //BA.debugLineNum = 81;BA.debugLine="timer3.Enabled = True";
_timer3.setEnabled(__c.True);
 //BA.debugLineNum = 84;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper  _getbase() throws Exception{
 //BA.debugLineNum = 94;BA.debugLine="Public Sub GetBase As Pane";
...
public String  _innerlabel_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 149;BA.debugLine="Public Sub InnerLabel_MousePressed (EventData As M";
 //BA.debugLineNum = 151;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_MousePr";
...
public String  _setbg(String _color) throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Public Sub SetBg(color As String)";
 //BA.debugLineNum = 106;BA.debugLine="End Sub";
return "";
}
public String  _setborder(String _color,int _width) throws Exception{
 //BA.debugLineNum = 120;BA.debugLine="Public Sub setBorder(color As String , width As In";
 //BA.debugLineNum = 124;BA.debugLine="End Sub";
return "";
}
public String  _setborderradius(int _radius) throws Exception{
 //BA.debugLineNum = 127;BA.debugLine="Public Sub setBorderRadius(radius As Int)";
...
public String  _setrotationx(float _angle) throws Exception{
 //BA.debugLineNum = 114;BA.debugLine="Public Sub setRotationX(angle As Float)";
 //BA.debugLineNum = 118;BA.debugLine="End Sub";
return "";
}
public String  _settextcolor(String _color) throws Exception{
 //BA.debugLineNum = 108;BA.debugLine="Public Sub setTextColor(color As String)";
 //BA.debugLineNum = 112;BA.debugLine="End Sub";
return "";
}
public String  _timer1_tick() throws Exception{
int _height = 0;
 //BA.debugLineNum = 33;BA.debugLine="Sub Timer1_Tick";
 //BA.debugLineNum = 36;BA.debugLine="Dim height As Int = ( Rnd(30, 100) / 100 ) *  mBa";
_height = (int) ((__c.Rnd((int) (30),(int) (100))/(double)100)*_mbase.getPrefHeight());
 //BA.debugLineNum = 38;BA.debugLine="Pane1.SetLayoutAnimated( 300 , Pane1.Left, Pane1.";
...
int _height = 0;
 //BA.debugLineNum = 42;BA.debugLine="Sub Timer2_Tick";
 //BA.debugLineNum = 45;BA.debugLine="Dim height As Int = ( Rnd(30, 100) / 100  ) *  mB";
_height = (int) ((__c.Rnd((int) (30),(int) (100))/(double)100)*_mbase.getPrefHeight());
 //BA.debugLineNum = 47;BA.debugLine="Pane2.SetLayoutAnimated(300 , Pane2.Left, Pane2.T";
...
int _height = 0;
 //BA.debugLineNum = 51;BA.debugLine="Sub Timer3_Tick";
 //BA.debugLineNum = 54;BA.debugLine="Dim height As Int =(  Rnd(30, 100) /100 ) *  mBas";
_height = (int) ((__c.Rnd((int) (30),(int) (100))/(double)100)*_mbase.getPrefHeight());
 //BA.debugLineNum = 56;BA.debugLine="Log(height)";
__c.Log(BA.NumberToString(_height));
 //BA.debugLineNum = 58;BA.debugLine="Pane3.SetLayoutAnimated(300 , Pane3.Left, Pane3.T";
