...
public String  _base_resize(double _width,double _height) throws Exception{
 ...
 //BA.debugLineNum = 30;BA.debugLine="InnerLabel.PrefWidth = Width";
_innerlabel.setPrefWidth(_width);
 //BA.debugLineNum = 31;BA.debugLine="InnerLabel.PrefHeight =  Height";
...
_mbase = new anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper();
 //BA.debugLineNum = 12;BA.debugLine="Private InnerLabel As Label";
...
_mbase.LoadLayout(ba,"MaterialButtonLayout");
 //BA.debugLineNum = 24;BA.debugLine="SetBg(StyleManager.DefaultTheme.Get(\"primary_text";
_setbg(BA.ObjectToString(_stylemanager._defaulttheme.Get((Object)("primary_text"))));
 //BA.debugLineNum = 25;BA.debugLine="InnerLabel.Font = StyleManager.SelectFont(\"Light:";
...
public String  _innerlabel_mousepressed(anywheresoftware.b4j.objects.NodeWrapper.MouseEventWrapper _eventdata) throws Exception{
 //BA.debugLineNum = 84;BA.debugLine="Public Sub InnerLabel_MousePressed (EventData As M";
...
public String  _removeeffects() throws Exception{
 ...
 //BA.debugLineNum = 77;BA.debugLine="ControlsUtils.removeEffect(InnerLabel)";
...
public String  _setbg(String _color) throws Exception{
 ...
 //BA.debugLineNum = 45;BA.debugLine="CSSUtils.SetStyleProperty( InnerLabel, \"-fx-backg";
_cssutils._setstyleproperty((anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.objects.NodeWrapper.ConcreteNodeWrapper(), (javafx.scene.Node)(_innerlabel.getObject())),"-fx-background-color",_color);
 //BA.debugLineNum = 47;BA.debugLine="End Sub";
return "";
}
public String  _setborder(String _color,int _width) throws Exception{
 //BA.debugLineNum = 55;BA.debugLine="Public Sub setBorder(color As String , width As In";
 //BA.debugLineNum = 57;BA.debugLine="ControlsUtils.setBorder(InnerLabel, color, width)";
...
public String  _setborderradius(int _radius) throws Exception{
 ...
 //BA.debugLineNum = 64;BA.debugLine="ControlsUtils.setBorderRadius(InnerLabel, radius)";
...
public String  _seteffect(String _effect) throws Exception{
 ...
 //BA.debugLineNum = 71;BA.debugLine="ControlsUtils.setEffect(InnerLabel, effect)";
...
public String  _setrotationx(float _angle) throws Exception{
 ...
 //BA.debugLineNum = 51;BA.debugLine="ControlsUtils.setRotationX(InnerLabel, angle) 'ro";
