...
public class materialradiobox {
    public static RemoteObject myClass;
	public materialradiobox() {
	}
    public static PCBA staticBA = new PCBA(null, materialradiobox.class);
...
public static RemoteObject _checkboxpane = RemoteObject.declareNull("anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper");
public static RemoteObject _checkedpane = RemoteObject.declareNull("anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CheckboxPane",_ref.getField(false, "_checkboxpane"),"CHECKED_STATE",_ref.getField(false, "_checked_state"),"CheckedPane",_ref.getField(false, "_checkedpane"),"CSSUtils",_ref.getField(false, "_cssutils"),"fx",_ref.getField(false, "_fx"),"INDETERMINATE_STATE",_ref.getField(false, "_indeterminate_state"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname"),"UNCHECKED_STATE",_ref.getField(false, "_unchecked_state")};
}
}