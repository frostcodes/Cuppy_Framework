...
public class barpreloader {
    ...
    public static PCBA staticBA = new PCBA(null, barpreloader.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"fx",_ref.getField(false, "_fx"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname"),"Pane1",_ref.getField(false, "_pane1"),"Pane2",_ref.getField(false, "_pane2"),"Pane3",_ref.getField(false, "_pane3"),"timer1",_ref.getField(false, "_timer1"),"timer2",_ref.getField(false, "_timer2"),"timer3",_ref.getField(false, "_timer3")};
}
}