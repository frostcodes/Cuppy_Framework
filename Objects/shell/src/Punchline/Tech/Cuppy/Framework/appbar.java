...
public class appbar {
    ...
    public static PCBA staticBA = new PCBA(null, appbar.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"fx",_ref.getField(false, "_fx"),"InnerPane",_ref.getField(false, "_innerpane"),"Label1",_ref.getField(false, "_label1"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname")};
}
}