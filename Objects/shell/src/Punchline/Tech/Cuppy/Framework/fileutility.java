...
public class fileutility implements IRemote{
	public static fileutility mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
		mostCurrent = new fileutility();
		remoteMe = RemoteObject.declareNull("Punchline.Tech.Cuppy.Framework.fileutility");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("fileutility"), "Punchline.Tech.Cuppy.Framework.fileutility");
	}
    ...
    private static PCBA pcBA = new PCBA(null, fileutility.class);
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, fileutility.class);
