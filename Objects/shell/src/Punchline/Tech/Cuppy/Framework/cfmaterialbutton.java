...
public class cfmaterialbutton {
    public static RemoteObject myClass;
	public cfmaterialbutton() {
	}
    public static PCBA staticBA = new PCBA(null, cfmaterialbutton.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"fx",_ref.getField(false, "_fx"),"InnerButton",_ref.getField(false, "_innerbutton"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname")};
}
}