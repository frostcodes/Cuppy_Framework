...
public class materialcheckbox {
    ...
    public static PCBA staticBA = new PCBA(null, materialcheckbox.class);
...
public static RemoteObject _checkedlabel = RemoteObject.declareNull("anywheresoftware.b4j.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CheckboxPane",_ref.getField(false, "_checkboxpane"),"CHECKED_STATE",_ref.getField(false, "_checked_state"),"CheckedLabel",_ref.getField(false, "_checkedlabel"),"CSSUtils",_ref.getField(false, "_cssutils"),"fx",_ref.getField(false, "_fx"),"INDETERMINATE_STATE",_ref.getField(false, "_indeterminate_state"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname"),"UNCHECKED_STATE",_ref.getField(false, "_unchecked_state")};
}
}