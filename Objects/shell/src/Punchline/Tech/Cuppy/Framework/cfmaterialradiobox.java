...
public class cfmaterialradiobox {
    public static RemoteObject myClass;
	public cfmaterialradiobox() {
	}
    public static PCBA staticBA = new PCBA(null, cfmaterialradiobox.class);
