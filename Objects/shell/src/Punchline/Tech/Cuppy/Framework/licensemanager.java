...
public class licensemanager implements IRemote{
	public static licensemanager mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
		mostCurrent = new licensemanager();
		remoteMe = RemoteObject.declareNull("Punchline.Tech.Cuppy.Framework.licensemanager");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("licensemanager"), "Punchline.Tech.Cuppy.Framework.licensemanager");
	}
    ...
    private static PCBA pcBA = new PCBA(null, licensemanager.class);
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, licensemanager.class);
        main_subs_0.initializeProcessGlobals();
		return pcBA;
	}
public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _licensekey = RemoteObject.createImmutable("");
