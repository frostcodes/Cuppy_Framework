...
public class metrocircletogglebutton {
    public static RemoteObject myClass;
	public metrocircletogglebutton() {
	}
    public static PCBA staticBA = new PCBA(null, metrocircletogglebutton.class);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CHECKED_STATE",_ref.getField(false, "_checked_state"),"CheckedStatus",_ref.getField(false, "_checkedstatus"),"CSSUtils",_ref.getField(false, "_cssutils"),"fx",_ref.getField(false, "_fx"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname"),"ToggleButton",_ref.getField(false, "_togglebutton"),"UNCHECKED_STATE",_ref.getField(false, "_unchecked_state")};
}
}