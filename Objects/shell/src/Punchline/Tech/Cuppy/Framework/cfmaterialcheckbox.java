...
public class cfmaterialcheckbox {
    public static RemoteObject myClass;
	public cfmaterialcheckbox() {
	}
    public static PCBA staticBA = new PCBA(null, cfmaterialcheckbox.class);
