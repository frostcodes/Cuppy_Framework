...
public class datatypeutility implements IRemote{
	public static datatypeutility mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
		mostCurrent = new datatypeutility();
		remoteMe = RemoteObject.declareNull("Punchline.Tech.Cuppy.Framework.datatypeutility");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("datatypeutility"), "Punchline.Tech.Cuppy.Framework.datatypeutility");
	}
    ...
    private static PCBA pcBA = new PCBA(null, datatypeutility.class);
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, datatypeutility.class);
