...
public class chips {
    ...
    public static PCBA staticBA = new PCBA(null, chips.class);
...
public static RemoteObject _innerbuttonpane = RemoteObject.declareNull("anywheresoftware.b4j.objects.PaneWrapper.ConcretePaneWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CSSUtils",_ref.getField(false, "_cssutils"),"fx",_ref.getField(false, "_fx"),"InnerButtonPane",_ref.getField(false, "_innerbuttonpane"),"InnerLabel",_ref.getField(false, "_innerlabel"),"InnerPane",_ref.getField(false, "_innerpane"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname")};
}
}